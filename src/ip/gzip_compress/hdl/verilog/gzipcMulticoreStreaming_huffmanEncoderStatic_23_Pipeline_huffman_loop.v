...
module gzipcMulticoreStreaming_huffmanEncoderStatic_23_Pipeline_huffman_loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
wire   [31:0] next_state_16_load_fu_358_p1;
wire   [0:0] done_load_load_fu_393_p1;
reg    ap_predicate_op51_read_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg   [31:0] next_state_16_reg_862;
reg   [31:0] next_state_16_reg_862_pp0_iter2_reg;
...
wire   [4:0] dist_blen_fixed15_address0;
wire   [2:0] dist_blen_fixed15_q0;
...
reg   [7:0] tCh_reg_895;
wire   [7:0] tLen_16_fu_421_p4;
reg   [7:0] tLen_16_reg_900;
reg   [15:0] tOffset_16_reg_905;
wire   [0:0] icmp_ln342_fu_517_p2;
reg   [4:0] code_s_8_reg_934;
reg   [2:0] dist_blen_fixed15_load_reg_939;
...
wire   [7:0] dextra_9_cast_cast_fu_559_p1;
wire    ap_loop_init;
reg   [7:0] lextra_fu_116;
wire   [7:0] lextra_8_cast_cast_fu_598_p1;
reg   [0:0] done_fu_120;
wire   [0:0] done_248_fu_411_p2;
reg   [15:0] lcode_fu_124;
wire   [15:0] zext_ln340_7_fu_630_p1;
reg   [15:0] ap_sig_allocacmp_lcode_load;
reg   [15:0] dcode_fu_128;
wire   [15:0] zext_ln339_8_fu_626_p1;
reg   [15:0] ap_sig_allocacmp_dcode_load_8;
reg   [31:0] curEncodedValue_fu_132;
wire   [31:0] nextEncodedValue_data_fu_399_p1;
reg   [7:0] tLen_fu_136;
wire   [7:0] tLen_15_fu_714_p2;
reg   [15:0] tOffset_fu_140;
wire   [15:0] tOffset_15_fu_672_p2;
...
wire   [19:0] tmp_208_fu_686_p4;
reg   [19:0] hufCodeStream_din_local;
reg    ap_block_pp0_stage0_01001;
wire   [19:0] tmp_207_fu_724_p5;
wire   [19:0] tmp_206_fu_748_p4;
wire   [19:0] tmp_s_fu_763_p4;
wire   [19:0] tmp_209_fu_778_p4;
reg    hufCodeStream_write_local;
reg    dist_codes_fixed29_ce0_local;
reg    dist_blen_fixed15_ce0_local;
reg    huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_dbits37_ce0_local;
reg    huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_lbits45_ce0_local;
reg    dist_code22_ce0_local;
reg    length_code52_ce0_local;
reg    base_dist1_ce0_local;
reg    base_length8_ce0_local;
reg    lit_code_fixed66_ce0_local;
reg   [8:0] lit_code_fixed66_address0_local;
reg    lit_blen_fixed59_ce0_local;
reg   [8:0] lit_blen_fixed59_address0_local;
wire   [0:0] nextEncodedValue_strobe_fu_403_p3;
wire   [7:0] tmp_288_fu_441_p4;
wire   [0:0] bit_sel_fu_467_p3;
wire   [0:0] xor_ln339_fu_475_p2;
wire   [7:0] part_sel_fu_481_p4;
wire   [0:0] icmp_ln339_fu_451_p2;
wire   [8:0] tOffset_1670_cast_fu_457_p4;
wire   [8:0] xor_ln_fu_491_p3;
wire   [8:0] dcode_8_fu_499_p3;
...
wire   [14:0] zext_ln345_7_fu_774_p1;
reg    ap_done_reg;
    ...
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            dcode_fu_128[4] <= 1'b0;
                        ...
                        dcode_fu_128[4 : 0] <= zext_ln339_8_fu_626_p1[4 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((next_state_16_reg_862 == 32'd5) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
                        dextra_fu_112[3 : 0] <= dextra_9_cast_cast_fu_559_p1[3 : 0];
        end
    end
end
    ...
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            lcode_fu_124[4] <= 1'b0;
                        ...
                        lcode_fu_124[4 : 0] <= zext_ln340_7_fu_630_p1[4 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        end else if (((next_state_16_reg_862 == 32'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
                        lextra_fu_116[2 : 0] <= lextra_8_cast_cast_fu_598_p1[2 : 0];
        end
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (done_fu_120 == 1'd0) & (ap_sig_allocacmp_next_state_16 == 32'd0) & (icmp_ln342_fu_517_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
                next_state_fu_144[0] <= 1'b1;
        next_state_fu_144[1] <= 1'b0;
        next_state_fu_144[2] <= 1'b0;
    end else if (((1'b0 == ap_block_pp0_stage0_11001) & (next_state_16_load_fu_358_p1 == 32'd4) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
                next_state_fu_144[0] <= 1'b1;
        next_state_fu_144[1] <= 1'b0;
        next_state_fu_144[2] <= 1'b1;
    end else if ((((1'b0 == ap_block_pp0_stage0_11001) & (done_fu_120 == 1'd0) & (ap_sig_allocacmp_next_state_16 == 32'd0) & (icmp_ln342_fu_517_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (next_state_16_load_fu_358_p1 == 32'd6) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
                next_state_fu_144[0] <= 1'b0;
        next_state_fu_144[1] <= 1'b0;
        next_state_fu_144[2] <= 1'b0;
    end else if (((next_state_16_reg_862 == 32'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
                next_state_fu_144[2 : 0] <= select_ln365_fu_608_p3[2 : 0];
    end else if (((next_state_16_reg_862 == 32'd5) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
                next_state_fu_144[2 : 0] <= select_ln379_fu_569_p3[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((((icmp_ln342_reg_920 == 1'd1) & (done_load_reg_891 == 1'd0) & (next_state_16_reg_862 == 32'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        tLen_fu_136 <= 8'd0;
    end else if (((icmp_ln342_reg_920 == 1'd0) & (done_load_reg_891 == 1'd0) & (next_state_16_reg_862 == 32'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        next_state_16_reg_862[2 : 0] <= ap_sig_allocacmp_next_state_16[2 : 0];
        tCh_reg_895 <= tCh_fu_417_p1;
        tLen_16_reg_900 <= {{curEncodedValue_fu_132[15:8]}};
        tOffset_16_reg_905 <= {{curEncodedValue_fu_132[31:16]}};
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ap_predicate_pred195_state4 <= (next_state_16_reg_862 == 32'd1);
        ap_predicate_pred203_state4 <= (next_state_16_reg_862 == 32'd5);
        ap_predicate_pred208_state4 <= (next_state_16_reg_862 == 32'd4);
        ap_predicate_pred213_state4 <= (next_state_16_reg_862 == 32'd6);
        ...
        next_state_16_reg_862_pp0_iter2_reg[2 : 0] <= next_state_16_reg_862[2 : 0];
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (done_load_load_fu_393_p1 == 1'd1) & (ap_sig_allocacmp_next_state_16 == 32'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((done_load_reg_891 == 1'd0) & (next_state_16_reg_862 == 32'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        if ((next_state_16_reg_862 == 32'd1)) begin
            ap_sig_allocacmp_next_state_16 = select_ln365_fu_608_p3;
        end else if ((next_state_16_reg_862 == 32'd5)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        base_dist1_ce0_local = 1'b1;
    end else begin
        base_dist1_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        base_length8_ce0_local = 1'b1;
    end else begin
        base_length8_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dist_blen_fixed15_ce0_local = 1'b1;
    end else begin
        dist_blen_fixed15_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dist_code22_ce0_local = 1'b1;
    end else begin
        dist_code22_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dist_codes_fixed29_ce0_local = 1'b1;
    end else begin
        dist_codes_fixed29_ce0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_dbits37_ce0_local = 1'b1;
    end else begin
        huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_dbits37_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_lbits45_ce0_local = 1'b1;
    end else begin
        huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_lbits45_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        length_code52_ce0_local = 1'b1;
    end else begin
        length_code52_ce0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        if ((1'b1 == ap_condition_307)) begin
            lit_blen_fixed59_address0_local = zext_ln345_fu_652_p1;
        end else if ((next_state_16_reg_862 == 32'd1)) begin
            lit_blen_fixed59_address0_local = zext_ln352_fu_592_p1;
        end else begin
            lit_blen_fixed59_address0_local = 'bx;
        end
    end else begin
        lit_blen_fixed59_address0_local = 'bx;
    end
...
always @ (*) begin
    if ((((icmp_ln342_reg_920 == 1'd1) & (done_load_reg_891 == 1'd0) & (next_state_16_reg_862 == 32'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((next_state_16_reg_862 == 32'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
        lit_blen_fixed59_ce0_local = 1'b1;
    end else begin
        lit_blen_fixed59_ce0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        if ((1'b1 == ap_condition_307)) begin
            lit_code_fixed66_address0_local = zext_ln345_fu_652_p1;
        end else if ((next_state_16_reg_862 == 32'd1)) begin
            lit_code_fixed66_address0_local = zext_ln352_fu_592_p1;
        end else begin
            lit_code_fixed66_address0_local = 'bx;
        end
    end else begin
        lit_code_fixed66_address0_local = 'bx;
    end
...
always @ (*) begin
    if ((((icmp_ln342_reg_920 == 1'd1) & (done_load_reg_891 == 1'd0) & (next_state_16_reg_862 == 32'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((next_state_16_reg_862 == 32'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
        lit_code_fixed66_ce0_local = 1'b1;
    end else begin
        lit_code_fixed66_ce0_local = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter3 = (((ap_predicate_op158_write_state4 == 1'b1) & (hufCodeStream_full_n == 1'b0)) | ((next_state_16_reg_862_pp0_iter2_reg == 32'd1) & (hufCodeStream_full_n == 1'b0)) | ((next_state_16_reg_862_pp0_iter2_reg == 32'd5) & (hufCodeStream_full_n == 1'b0)) | ((next_state_16_reg_862_pp0_iter2_reg == 32'd4) & (hufCodeStream_full_n == 1'b0)) | ((next_state_16_reg_862_pp0_iter2_reg == 32'd6) & (hufCodeStream_full_n == 1'b0)));
end

always @ (*) begin
    ap_condition_307 = ((icmp_ln342_reg_920 == 1'd1) & (done_load_reg_891 == 1'd0) & (next_state_16_reg_862 == 32'd0));
end

always @ (*) begin
    ap_condition_669 = ((done_fu_120 == 1'd0) & (ap_sig_allocacmp_next_state_16 == 32'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_672 = ((done_load_reg_891 == 1'd0) & (next_state_16_reg_862 == 32'd0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
always @ (*) begin
    ap_predicate_op158_write_state4 = ((icmp_ln342_reg_920_pp0_iter2_reg == 1'd1) & (done_load_reg_891_pp0_iter2_reg == 1'd0) & (next_state_16_reg_862_pp0_iter2_reg == 32'd0));
end

always @ (*) begin
    ap_predicate_op51_read_state2 = ((done_fu_120 == 1'd0) & (ap_sig_allocacmp_next_state_16 == 32'd0));
end

assign ap_ready = ap_ready_sig;

assign base_dist1_address0 = zext_ln388_fu_546_p1;

assign base_dist_load_cast_fu_668_p1 = base_dist1_q0;

assign base_length8_address0 = zext_ln380_fu_554_p1;

assign bit_sel_fu_467_p3 = curEncodedValue_fu_132[32'd31];

assign dcode_8_fu_499_p3 = ((icmp_ln339_fu_451_p2[0:0] == 1'b1) ? tOffset_1670_cast_fu_457_p4 : xor_ln_fu_491_p3);

assign dextra_9_cast_cast_fu_559_p1 = huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_dbits37_q0;

assign dist_blen_fixed15_address0 = zext_ln366_fu_374_p1;

assign dist_blen_fixed_load_cast_fu_742_p1 = dist_blen_fixed15_load_reg_939;

assign dist_code22_address0 = zext_ln339_fu_507_p1;

assign dist_codes_fixed29_address0 = zext_ln366_fu_374_p1;

assign done_248_fu_411_p2 = (nextEncodedValue_strobe_fu_403_p3 ^ 1'd1);
...
assign huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_dbits37_address0 = zext_ln366_fu_374_p1;

assign huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_lbits45_address0 = zext_ln354_fu_388_p1;

assign icmp_ln339_fu_451_p2 = ((tmp_288_fu_441_p4 == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln342_fu_517_p2 = ((tLen_16_fu_421_p4 == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln360_fu_602_p2 = ((huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_lbits45_q0 != 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln374_fu_563_p2 = ((huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_dbits37_q0 != 4'd0) ? 1'b1 : 1'b0);

assign length_code52_address0 = zext_ln340_fu_512_p1;

assign lextra_8_cast_cast_fu_598_p1 = huffmanEncoderStatic_stream_stream_DSVectorStream_dt_0_extra_lbits45_q0;

assign newFirst_fu_708_p2 = ($signed(8'd253) - $signed(base_length8_q0));
...
assign next_state_16_load_fu_358_p1 = ap_sig_allocacmp_next_state_16;
...
assign tLen_15_fu_714_p2 = (tLen_fu_136 + newFirst_fu_708_p2);

assign tLen_16_fu_421_p4 = {{curEncodedValue_fu_132[15:8]}};

assign tOffset_15_fu_672_p2 = (tOffset_fu_140 - base_dist_load_cast_fu_668_p1);

assign tOffset_1670_cast_fu_457_p4 = {{curEncodedValue_fu_132[24:16]}};

assign tmp_206_fu_748_p4 = {{{{1'd1}, {dist_blen_fixed_load_cast_fu_742_p1}}}, {zext_ln370_fu_745_p1}};

assign tmp_207_fu_724_p5 = {{{{{{1'd1}, {trunc_ln382_fu_720_p1}}}, {7'd0}}}, {tLen_15_fu_714_p2}};

assign tmp_208_fu_686_p4 = {{{{1'd1}, {trunc_ln390_fu_682_p1}}}, {trunc_ln389_fu_678_p1}};

assign tmp_209_fu_778_p4 = {{{{1'd1}, {lit_blen_fixed59_q0}}}, {zext_ln345_7_fu_774_p1}};

assign tmp_288_fu_441_p4 = {{curEncodedValue_fu_132[31:24]}};

assign tmp_s_fu_763_p4 = {{{{1'd1}, {lit_blen_fixed59_q0}}}, {zext_ln356_fu_759_p1}};

assign trunc_ln352_fu_384_p1 = ap_sig_allocacmp_lcode_load[8:0];

assign trunc_ln382_fu_720_p1 = lextra_fu_116[3:0];

assign trunc_ln389_fu_678_p1 = tOffset_15_fu_672_p2[14:0];
...
assign zext_ln339_8_fu_626_p1 = dist_code22_q0;

assign zext_ln339_fu_507_p1 = dcode_8_fu_499_p3;

assign zext_ln340_7_fu_630_p1 = length_code52_q0;

assign zext_ln340_fu_512_p1 = tLen_16_fu_421_p4;

assign zext_ln345_7_fu_774_p1 = lit_code_fixed66_q0;
...
assign zext_ln356_fu_759_p1 = lit_code_fixed66_q0;

assign zext_ln366_fu_374_p1 = ap_sig_allocacmp_dcode_load_8;

assign zext_ln370_fu_745_p1 = code_s_8_reg_934;
...
always @ (posedge ap_clk) begin
    next_state_16_reg_862[31:3] <= 29'b00000000000000000000000000000;
    next_state_16_reg_862_pp0_iter2_reg[31:3] <= 29'b00000000000000000000000000000;
...
endmodule //gzipcMulticoreStreaming_huffmanEncoderStatic_23_Pipeline_huffman_loop
