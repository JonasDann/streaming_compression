...
module gzipcMulticoreStreaming_huffmanProcessingUnit_28_Pipeline_hf_proc_static_main (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        empty,
        outValue_data_77_out,
        outValue_data_77_out_ap_vld
);
...
input  [8:0] empty;
output  [31:0] outValue_data_77_out;
output   outValue_data_77_out_ap_vld;

reg ap_idle;
reg outValue_data_77_out_ap_vld;
...
wire   [31:0] outValue_data_49_fu_199_p5;
wire   [31:0] outValue_data_51_fu_251_p5;
wire   [0:0] done_238_fu_303_p2;
reg   [0:0] done_238_reg_383;
wire    ap_loop_init;
wire   [31:0] ap_phi_reg_pp0_iter0_outValue_data_52_reg_124;
reg   [31:0] ap_phi_reg_pp0_iter1_outValue_data_52_reg_124;
reg   [31:0] ap_phi_reg_pp0_iter2_outValue_data_52_reg_124;
...
wire   [31:0] outValue_data_48_fu_220_p5;
wire   [31:0] outValue_data_50_fu_281_p5;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_phi_mux_done_phi_fu_116_p4 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outValue_data_77_out_ap_vld = 1'b1;
    end else begin
        outValue_data_77_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_phi_mux_done_phi_fu_116_p4 == 1'd0) & (lz77Stream_2_empty_n == 1'b0));
end
...
assign ap_phi_reg_pp0_iter0_outValue_data_52_reg_124 = 'bx;
...
assign done_238_fu_303_p2 = (nextValue_strobe_fu_187_p3 ^ 1'd1);
...
assign lz77Stream_2_read = lz77Stream_2_read_local;

assign nextValue_strobe_fu_187_p3 = lz77Stream_2_dout[32'd9];

assign next_state_load_load_fu_172_p1 = next_state_fu_78;

assign outValue_data_48_fu_220_p5 = {{outValue_data_fu_82[31:24]}, {trunc_ln257_fu_216_p1}, {outValue_data_fu_82[15:0]}};

assign outValue_data_49_fu_199_p5 = {{trunc_ln262_fu_195_p1}, {outValue_data_fu_82[23:0]}};

assign outValue_data_50_fu_281_p5 = {{outValue_data_fu_82[31:16]}, {tmp_fu_273_p3}};

assign outValue_data_51_fu_251_p5 = {{outValue_data_fu_82[31:8]}, {trunc_ln247_fu_247_p1}};

assign outValue_data_77_out = outValue_data_fu_82;

assign tmp_fu_273_p3 = {{trunc_ln247_fu_247_p1}, {8'd0}};

assign tmp_s_fu_317_p3 = {{outValue_strobe_fu_74}, {ap_phi_reg_pp0_iter2_outValue_data_52_reg_124}};

assign tokenFlag_fu_175_p3 = zext_ln222_fu_168_p1[32'd8];

assign trunc_ln242_fu_183_p1 = lz77Stream_2_dout[8:0];
...
endmodule //gzipcMulticoreStreaming_huffmanProcessingUnit_28_Pipeline_hf_proc_static_main
