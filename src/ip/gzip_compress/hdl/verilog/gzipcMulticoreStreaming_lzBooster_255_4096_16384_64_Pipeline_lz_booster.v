...
input  [0:0] empty;
input  [31:0] outValue;
output  [31:0] outValue_32_out;
output   outValue_32_out_ap_vld;

reg ap_idle;
reg outValue_32_out_ap_vld;
...
reg   [0:0] tmp_217_reg_739;
reg   [31:0] outValue_1_reg_744;
reg   [31:0] outValue_1_reg_744_pp0_iter2_reg;
...
reg   [31:0] outStreamValue_data_load_2_reg_807;
reg    ap_condition_exit_pp0_iter3_stage0;
wire   [11:0] local_mem_address0;
wire   [11:0] local_mem_address1;
wire   [7:0] local_mem_q1;
wire    ap_loop_init;
reg   [8:0] ap_phi_mux_skip_len_4168_phi_fu_238_p4;
wire  signed [8:0] skip_len_4_fu_496_p3;
wire   [8:0] ap_phi_reg_pp0_iter3_skip_len_4168_reg_235;
reg   [0:0] ap_phi_mux_matchFlag_4162_phi_fu_248_p4;
wire   [0:0] ap_phi_reg_pp0_iter3_matchFlag_4162_reg_245;
reg   [7:0] ap_phi_mux_empty_251_phi_fu_258_p10;
wire   [7:0] ap_phi_reg_pp0_iter4_empty_251_reg_255;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_217_reg_739 <= compressedStream1_dout[32'd32];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_328)) begin
        if ((icmp_ln508_fu_477_p2 == 1'd1)) begin
            ap_phi_mux_matchFlag_4162_phi_fu_248_p4 = 1'd0;
...
always @ (*) begin
    if ((1'b1 == ap_condition_328)) begin
        if ((icmp_ln508_fu_477_p2 == 1'd1)) begin
            ap_phi_mux_skip_len_4168_phi_fu_238_p4 = 9'd0;
        end else if ((icmp_ln508_fu_477_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_exit_ready_pp0_iter3_reg == 1'b1) & (nextVal_strobe_reg_224_pp0_iter2_reg == 1'd0))) begin
        outValue_32_out_ap_vld = 1'b1;
    end else begin
        outValue_32_out_ap_vld = 1'b0;
    end
end
...
assign ap_phi_reg_pp0_iter3_matchFlag_4162_reg_245 = 'bx;

assign ap_phi_reg_pp0_iter3_skip_len_4168_reg_235 = 'bx;

assign ap_phi_reg_pp0_iter4_empty_251_reg_255 = 'bx;
...
assign boostFlag_fu_363_p2 = ((tmp_218_fu_353_p4 == 4'd0) ? 1'b1 : 1'b0);
...
assign empty_252_fu_405_p1 = match_loc_fu_116[11:0];

assign empty_253_fu_382_p1 = iIdx_fu_108[11:0];

assign iIdx_10_fu_376_p2 = (iIdx_fu_108 + 32'd1);
...
assign match_len_2_fu_583_p2 = (match_len_fu_120 + 32'd1);

assign match_loc_3_fu_589_p2 = (match_loc_fu_116 + 32'd1);

assign match_loc_4_fu_463_p2 = (iIdx_9_reg_775 - zext_ln504_fu_460_p1);

assign outFlag_fu_472_p2 = ((iIdx_9_reg_775 != 32'd0) ? 1'b1 : 1'b0);

assign outValue_2_fu_603_p5 = {{outStreamValue_data_fu_128[31:16]}, {trunc_ln501_fu_599_p1}, {outStreamValue_data_fu_128[7:0]}};

assign outValue_32_out = outStreamValue_data_fu_128;

assign sext_ln449_fu_504_p1 = skip_len_4_fu_496_p3;

assign sext_ln522_fu_555_p1 = $signed(ap_phi_mux_skip_len_4168_phi_fu_238_p4);

assign skip_len_2_fu_415_p2 = ($signed(skip_len_fu_104) + $signed(16'd65535));

assign skip_len_3_fu_490_p2 = ($signed(zext_ln514_fu_487_p1) + $signed(9'd511));

assign skip_len_4_fu_496_p3 = ((boostFlag_reg_768_pp0_iter2_reg[0:0] == 1'b1) ? 9'd0 : skip_len_3_fu_490_p2);

assign tCh_fu_329_p1 = lclBufStream_dout[7:0];

assign tmp_218_fu_353_p4 = {{lclBufStream_dout[31:28]}};

assign tmp_s_fu_645_p3 = {{1'd1}, {outStreamValue_data_load_2_reg_807}};

assign trunc_ln441_1_fu_468_p1 = match_loc_4_fu_463_p2[11:0];

assign trunc_ln441_fu_595_p1 = match_loc_3_fu_589_p2[11:0];

assign trunc_ln479_fu_313_p1 = compressedStream1_dout[31:0];

assign trunc_ln501_fu_599_p1 = match_len_2_fu_583_p2[7:0];

assign zext_ln493_fu_386_p1 = empty_253_fu_382_p1;
...
assign zext_ln520_2_fu_482_p1 = trunc_ln441_1_fu_468_p1;

assign zext_ln520_fu_421_p1 = empty_252_fu_405_p1;
