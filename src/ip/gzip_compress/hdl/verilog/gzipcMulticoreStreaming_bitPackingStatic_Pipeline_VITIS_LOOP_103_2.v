...
module gzipcMulticoreStreaming_bitPackingStatic_Pipeline_VITIS_LOOP_103_2 (
        ...
        huffStream_7_write,
        packedBits,
        outValue_data_176_reload,
        zext_ln42,
        outValue_data_181_out,
        outValue_data_181_out_ap_vld
);
...
input  [7:0] outValue_data_176_reload;
input  [7:0] zext_ln42;
output  [7:0] outValue_data_181_out;
output   outValue_data_181_out_ap_vld;

reg ap_idle;
reg outValue_data_181_out_ap_vld;
...
wire   [7:0] outValue_data_69_fu_211_p3;
wire    ap_loop_init;
reg   [63:0] packedBits_1_fu_76;
wire   [63:0] zext_ln105_fu_193_p1;
reg   [8:0] i_fu_80;
wire   [8:0] i_53_fu_166_p2;
reg   [8:0] ap_sig_allocacmp_i_52;
...
wire   [7:0] outValue_data_68_fu_201_p4;
wire   [1:0] select_ln114_fu_218_p3;
wire   [7:0] outValue_data_67_fu_197_p1;
reg    ap_done_reg;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln103_fu_138_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outValue_data_181_out_ap_vld = 1'b1;
    end else begin
        outValue_data_181_out_ap_vld = 1'b0;
    end
end
...
assign huffStream_7_din = p_0_fu_225_p4;

assign huffStream_7_write = huffStream_7_write_local;

assign i_53_fu_166_p2 = (ap_sig_allocacmp_i_52 + 9'd16);

assign icmp_ln103_fu_138_p2 = ((ap_sig_allocacmp_i_52 < zext_ln42_cast_fu_116_p1) ? 1'b1 : 1'b0);

assign icmp_ln108_fu_160_p2 = ((tmp_fu_150_p4 == 5'd0) ? 1'b1 : 1'b0);

assign outValue_data_181_out = outValue_data_fu_72;

assign outValue_data_67_fu_197_p1 = packedBits_1_fu_76[7:0];

assign outValue_data_68_fu_201_p4 = {{packedBits_1_fu_76[15:8]}};

assign outValue_data_69_fu_211_p3 = ((icmp_ln108_reg_275[0:0] == 1'b1) ? outValue_data_fu_72 : outValue_data_68_fu_201_p4);

assign p_0_fu_225_p4 = {{{select_ln114_fu_218_p3}, {outValue_data_69_fu_211_p3}}, {outValue_data_67_fu_197_p1}};
...
assign sub_ln108_fu_144_p2 = (zext_ln42_cast_fu_116_p1 - ap_sig_allocacmp_i_52);
