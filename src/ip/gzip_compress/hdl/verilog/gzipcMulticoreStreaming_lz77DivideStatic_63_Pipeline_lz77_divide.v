...
module gzipcMulticoreStreaming_lz77DivideStatic_63_Pipeline_lz77_divide (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [0:0] just_started_2_out;
output   just_started_2_out_ap_vld;

reg ap_idle;
reg conv2_i_i164_out_ap_vld;
reg just_started_2_out_ap_vld;
...
reg   [31:0] next_state_2_reg_340;
reg   [31:0] next_state_2_reg_340_pp0_iter1_reg;
...
reg   [31:0] ap_sig_allocacmp_next_state_2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        end else if (((next_state_2_reg_340 == 32'd2) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            conv2_i_i164_fu_88 <= zext_ln290_fu_236_p1;
        end else if (((next_state_2_reg_340 == 32'd1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((1'b1 == ap_condition_324)) begin
            ...
            next_state_fu_84[1] <= 1'b0;
        end else if (((ap_sig_allocacmp_next_state_2 == 32'd2) & (ap_start_int == 1'b1))) begin
                        next_state_fu_84[0] <= 1'b0;
            next_state_fu_84[1] <= 1'b0;
        end else if (((ap_sig_allocacmp_next_state_2 == 32'd1) & (ap_start_int == 1'b1))) begin
                        next_state_fu_84[0] <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        next_state_2_reg_340[1 : 0] <= ap_sig_allocacmp_next_state_2[1 : 0];
        next_state_2_reg_340_pp0_iter1_reg[1 : 0] <= next_state_2_reg_340[1 : 0];
...
always @ (*) begin
    if ((~(ap_sig_allocacmp_next_state_2 == 32'd1) & ~(ap_sig_allocacmp_next_state_2 == 32'd2) & (encodedValue_strobe_fu_163_p3 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_next_state_2 = 32'd0;
    end else begin
...
always @ (*) begin
    if ((~(next_state_2_reg_340 == 32'd1) & ~(next_state_2_reg_340 == 32'd2) & (encodedValue_strobe_reg_344 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
...
always @ (*) begin
    if ((~(next_state_2_reg_340 == 32'd1) & ~(next_state_2_reg_340 == 32'd2) & (encodedValue_strobe_reg_344 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        just_started_2_out_ap_vld = 1'b1;
    end else begin
        just_started_2_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((ap_predicate_op57_write_state3 == 1'b1) & (lz77Stream_1_full_n == 1'b0));
end

always @ (*) begin
    ap_condition_309 = (~(next_state_2_reg_340 == 32'd1) & ~(next_state_2_reg_340 == 32'd2) & (encodedValue_strobe_reg_344 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_310 = (~(next_state_2_reg_340 == 32'd1) & ~(next_state_2_reg_340 == 32'd2) & (encodedValue_strobe_reg_344 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln275_reg_368 == 1'd0));
end

always @ (*) begin
    ap_condition_313 = (~(next_state_2_reg_340 == 32'd1) & ~(next_state_2_reg_340 == 32'd2) & (encodedValue_strobe_reg_344 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln275_reg_368 == 1'd1));
end

always @ (*) begin
    ap_condition_321 = (~(ap_sig_allocacmp_next_state_2 == 32'd1) & ~(ap_sig_allocacmp_next_state_2 == 32'd2) & (encodedValue_strobe_fu_163_p3 == 1'd1) & (ap_start_int == 1'b1) & (icmp_ln275_fu_205_p2 == 1'd0));
end

always @ (*) begin
    ap_condition_324 = (~(ap_sig_allocacmp_next_state_2 == 32'd1) & ~(ap_sig_allocacmp_next_state_2 == 32'd2) & (encodedValue_strobe_fu_163_p3 == 1'd1) & (ap_start_int == 1'b1) & (icmp_ln275_fu_205_p2 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op27_read_state1 = (~(ap_sig_allocacmp_next_state_2 == 32'd1) & ~(ap_sig_allocacmp_next_state_2 == 32'd2));
end

always @ (*) begin
    ap_predicate_op57_write_state3 = ((next_state_2_reg_340_pp0_iter1_reg == 32'd2) | ((next_state_2_reg_340_pp0_iter1_reg == 32'd1) | (encodedValue_strobe_reg_344_pp0_iter1_reg == 1'd1)));
end
...
assign just_started_2_out = last_block_fu_72;

assign lz77Stream_1_din = tmp_171_fu_281_p3;

assign lz77Stream_1_write = lz77Stream_1_write_local;

assign tCh_fu_171_p1 = boosterStream_dout[7:0];

assign tLen_fu_175_p4 = {{boosterStream_dout[15:8]}};

assign tmp_171_fu_281_p3 = {{1'd1}, {conv2_i_i164_fu_88}};
...
always @ (posedge ap_clk) begin
    next_state_2_reg_340[31:2] <= 30'b000000000000000000000000000000;
    next_state_2_reg_340_pp0_iter1_reg[31:2] <= 30'b000000000000000000000000000000;
    next_state_fu_84[31:2] <= 30'b000000000000000000000000000000;
end

endmodule //gzipcMulticoreStreaming_lz77DivideStatic_63_Pipeline_lz77_divide
