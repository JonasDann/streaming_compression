...
module gzipcMulticoreStreaming_lzBestMatchFilter_6_32768_52_Pipeline_lz_bestMatchFilter (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] outValue_data_16_fu_166_p3;
reg   [31:0] outValue_data_16_reg_214;
reg    ap_block_pp0_stage0_11001;
reg   [32:0] nextVal_data_100_in_fu_60;
wire    ap_loop_init;
...
wire   [31:0] outValue_data_15_fu_154_p5;
reg    ap_done_reg;
...
#0 nextVal_data_100_in_fu_60 = 33'd0;
...
assign compareLen_fu_138_p4 = {{nextVal_data_100_in_fu_60[15:8]}};
...
assign nextVal_strobe_fu_117_p3 = nextVal_data_100_in_fu_60[32'd32];

assign outValue_data_15_fu_154_p5 = {{24'd0}, {outValue_data_fu_64[7:0]}};

assign outValue_data_16_fu_166_p3 = ((icmp_ln396_fu_148_p2[0:0] == 1'b1) ? outValue_data_15_fu_154_p5 : outValue_data_fu_64);

assign phi_ln366_out = outValue_data_fu_64;

assign tmp_s_fu_184_p3 = {{1'd1}, {outValue_data_16_reg_214}};

assign trunc_ln369_fu_113_p1 = nextVal_data_100_in_fu_60[31:0];

endmodule //gzipcMulticoreStreaming_lzBestMatchFilter_6_32768_52_Pipeline_lz_bestMatchFilter
