...
output  [7:0] outVal_data_40_out;
output   outVal_data_40_out_ap_vld;

reg ap_idle;
reg outVal_data_40_out_ap_vld;
...
#0 inVal_33_fu_72 = 68'd0;
#0 dsize_fu_76 = 4'd0;
#0 outVal_data_40_fu_80 = 8'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            outVal_data_40_fu_80 <= {{inVal_33_fu_72[11:4]}};
        end
    end
end
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln186_fu_168_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outVal_data_40_out_ap_vld = 1'b1;
    end else begin
        outVal_data_40_out_ap_vld = 1'b0;
    end
end
...
assign distStream_2_read = distStream_2_read_local;

assign downStream_2_din = tmp_s_fu_251_p3;

assign downStream_2_write = downStream_2_write_local;

assign dsize_23_fu_180_p2 = (dsize_fu_76 + 4'd1);
...
assign inSize_16_fu_201_p1 = distStream_2_dout[3:0];

assign inVal_34_fu_237_p4 = {{inVal_33_fu_72[67:8]}};

assign outVal_data_40_out = outVal_data_40_fu_80;

assign outVal_data_41_fu_227_p4 = {{inVal_33_fu_72[11:4]}};

assign tmp_s_fu_251_p3 = {{1'd1}, {outVal_data_41_fu_227_p4}};

assign zext_ln183_cast_fu_136_p1 = zext_ln183;

assign zext_ln189_fu_247_p1 = inVal_34_fu_237_p4;

assign zext_ln192_fu_186_p1 = dsize_23_fu_180_p2;

assign zext_ln196_fu_205_p1 = inSize_16_fu_201_p1;
