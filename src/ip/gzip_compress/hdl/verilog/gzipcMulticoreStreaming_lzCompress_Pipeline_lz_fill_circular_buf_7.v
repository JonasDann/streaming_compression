...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_fill_circular_buf_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [7:0] nextVal_data_1_fu_124_p1;
wire    ap_loop_init;
reg   [6:0] i_fu_60;
wire   [6:0] i_7_fu_109_p2;
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((lclBufStream_full_n == 1'b0) | (downStream_0_empty_n == 1'b0));
end
...
assign i_7_fu_109_p2 = (ap_sig_allocacmp_i_6 + 7'd1);

assign icmp_ln261_fu_103_p2 = ((ap_sig_allocacmp_i_6 == 7'd64) ? 1'b1 : 1'b0);

assign lclBufStream_din = nextVal_data_fu_56;

assign lclBufStream_write = lclBufStream_write_local;

assign nextVal_data_1_fu_124_p1 = downStream_0_dout[7:0];

assign p_phi10_out = p_phi10_fu_52;

endmodule //gzipcMulticoreStreaming_lzCompress_Pipeline_lz_fill_circular_buf_7
