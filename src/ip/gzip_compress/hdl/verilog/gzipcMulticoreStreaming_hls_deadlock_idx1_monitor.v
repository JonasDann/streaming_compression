...
module gzipcMulticoreStreaming_hls_deadlock_idx1_monitor ( // for module gzipcMulticoreStreaming_gzipcMulticoreStreaming_inst.gzipMulticoreCompressAxiStream_0_4_8_32_U0
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[0] = idx2_block & (1'b0 | axis_block_sigs[0] | axis_block_sigs[1]);
...
// instant sub module
 gzipcMulticoreStreaming_hls_deadlock_idx2_monitor gzipcMulticoreStreaming_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 gzipcMulticoreStreaming_hls_deadlock_idx4_monitor gzipcMulticoreStreaming_hls_deadlock_idx4_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
