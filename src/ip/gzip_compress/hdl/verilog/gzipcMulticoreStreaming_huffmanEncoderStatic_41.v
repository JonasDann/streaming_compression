...
module gzipcMulticoreStreaming_huffmanEncoderStatic_41 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    ap_block_state2;
wire    grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start;
wire    grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_done;
wire    grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_idle;
wire    grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_ready;
wire    grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_encodedOutStream_read;
wire   [19:0] grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_hufCodeStream_din;
wire    grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_hufCodeStream_write;
reg    grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start_reg;
reg   [5:0] ap_NS_fsm;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 6'd1;
#0 grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start_reg = 1'b0;
end

gzipcMulticoreStreaming_huffmanEncoderStatic_41_Pipeline_huffman_loop grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (1'b1 == ap_NS_fsm_state3))) begin
            grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start_reg <= 1'b1;
        end else if ((grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_ready == 1'b1)) begin
            grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start = grp_huffmanEncoderStatic_41_Pipeline_huffman_loop_fu_72_ap_start_reg;
...
endmodule //gzipcMulticoreStreaming_huffmanEncoderStatic_41
