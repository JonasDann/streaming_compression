...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_left_bytes (
        ...
        outValue_data_1_reload,
        outValue_data_3_out_i,
        outValue_data_3_out_o,
        outValue_data_3_out_o_ap_vld
);
...
input  [31:0] outValue_data_1_reload;
input  [31:0] outValue_data_3_out_i;
output  [31:0] outValue_data_3_out_o;
output   outValue_data_3_out_o_ap_vld;

reg ap_idle;
reg[31:0] outValue_data_3_out_o;
reg outValue_data_3_out_o_ap_vld;
...
wire    ap_loop_init;
reg   [6:0] l_fu_58;
wire   [6:0] l_16_fu_101_p2;
reg   [6:0] ap_sig_allocacmp_l_15;
...
always @ (*) begin
    if ((((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        outValue_data_3_out_o_ap_vld = 1'b1;
    end else begin
        outValue_data_3_out_o_ap_vld = 1'b0;
    end
end
...
assign icmp_ln355_fu_95_p2 = ((ap_sig_allocacmp_l_15 == 7'd64) ? 1'b1 : 1'b0);

assign l_16_fu_101_p2 = (ap_sig_allocacmp_l_15 + 7'd1);

assign lclBufStream_read = lclBufStream_read_local;

assign outValue_data_fu_116_p5 = {{outValue_data_3_out_i[31:8]}, {lclBufStream_dout}};
