...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_left_bytes_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        outValue_data_17_reload,
        outValue_data_19_out_i,
        outValue_data_19_out_o,
        outValue_data_19_out_o_ap_vld
);
...
input  [31:0] outValue_data_17_reload;
input  [31:0] outValue_data_19_out_i;
output  [31:0] outValue_data_19_out_o;
output   outValue_data_19_out_o_ap_vld;

reg ap_idle;
reg[31:0] outValue_data_19_out_o;
reg outValue_data_19_out_o_ap_vld;
...
always @ (*) begin
    if ((((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        outValue_data_19_out_o_ap_vld = 1'b1;
    end else begin
        outValue_data_19_out_o_ap_vld = 1'b0;
    end
end
...
assign icmp_ln355_fu_95_p2 = ((ap_sig_allocacmp_l_7 == 7'd64) ? 1'b1 : 1'b0);

assign l_8_fu_101_p2 = (ap_sig_allocacmp_l_7 + 7'd1);

assign lclBufStream_read = lclBufStream_read_local;

assign outValue_data_fu_116_p5 = {{outValue_data_19_out_i[31:8]}, {lclBufStream_dout}};

assign tmp_s_fu_128_p3 = {{1'd1}, {outValue_data_fu_116_p5}};

endmodule //gzipcMulticoreStreaming_lzCompress_Pipeline_lz_left_bytes_4
