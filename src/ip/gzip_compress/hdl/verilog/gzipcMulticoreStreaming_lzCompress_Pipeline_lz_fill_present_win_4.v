...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_fill_present_win_4 (
        ...
        present_window,
        empty,
        present_window_93_out,
        present_window_93_out_ap_vld,
        present_window_92_out,
        present_window_92_out_ap_vld,
        present_window_91_out,
        present_window_91_out_ap_vld,
        present_window_90_out,
        present_window_90_out_ap_vld,
...
input  [7:0] present_window_88;
input  [7:0] present_window_87;
input  [7:0] present_window_86;
input  [7:0] present_window_85;
input  [7:0] present_window;
input  [7:0] empty;
output  [7:0] present_window_93_out;
output   present_window_93_out_ap_vld;
output  [7:0] present_window_92_out;
output   present_window_92_out_ap_vld;
output  [7:0] present_window_91_out;
output   present_window_91_out_ap_vld;
output  [7:0] present_window_90_out;
output   present_window_90_out_ap_vld;
...
reg ap_idle;
reg present_window_93_out_ap_vld;
reg present_window_92_out_ap_vld;
reg present_window_91_out_ap_vld;
reg present_window_90_out_ap_vld;
...
#0 iIdx_fu_64 = 3'd0;
#0 present_window_25_fu_68 = 8'd0;
#0 present_window_26_fu_72 = 8'd0;
#0 present_window_27_fu_76 = 8'd0;
#0 present_window_28_fu_80 = 8'd0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln253_reg_342 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        present_window_90_out_ap_vld = 1'b1;
    end else begin
        present_window_90_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln253_reg_342 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        present_window_91_out_ap_vld = 1'b1;
    end else begin
        present_window_91_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln253_reg_342 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        present_window_92_out_ap_vld = 1'b1;
    end else begin
        present_window_92_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln253_reg_342 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1))) begin
        present_window_93_out_ap_vld = 1'b1;
    end else begin
        present_window_93_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_condition_227 = ((iIdx_4_reg_338 == 3'd0) & (icmp_ln253_reg_342 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_230 = ((iIdx_4_reg_338 == 3'd1) & (icmp_ln253_reg_342 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_233 = ((iIdx_4_reg_338 == 3'd2) & (icmp_ln253_reg_342 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_237 = ((iIdx_4_reg_338 == 3'd3) & (icmp_ln253_reg_342 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_243 = (~(iIdx_4_reg_338 == 3'd3) & ~(iIdx_4_reg_338 == 3'd2) & ~(iIdx_4_reg_338 == 3'd1) & ~(iIdx_4_reg_338 == 3'd0) & (icmp_ln253_reg_342 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign p_out = present_window_28_fu_80;

assign present_window_89_out = present_window_25_fu_68;

assign present_window_90_out = present_window_26_fu_72;

assign present_window_91_out = present_window_27_fu_76;

assign present_window_92_out = present_window_29_fu_84;

assign present_window_93_out = present_window_30_fu_88;
