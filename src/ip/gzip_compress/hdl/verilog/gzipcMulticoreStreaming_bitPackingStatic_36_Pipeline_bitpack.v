...
module gzipcMulticoreStreaming_bitPackingStatic_36_Pipeline_bitpack (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        empty,
        outValue_data,
        outValue_data_126_out,
        outValue_data_126_out_ap_vld,
        outValue_data_125_out,
        outValue_data_125_out_ap_vld,
        localBits_out,
...
output  [7:0] outValue_data_126_out;
output   outValue_data_126_out_ap_vld;
output  [7:0] outValue_data_125_out;
output   outValue_data_125_out_ap_vld;
...
reg ap_idle;
reg outValue_data_126_out_ap_vld;
reg outValue_data_125_out_ap_vld;
...
wire   [4:0] trunc_ln54_4_fu_278_p1;
reg   [4:0] trunc_ln54_4_reg_576;
wire   [0:0] icmp_ln57_fu_298_p2;
reg   [0:0] ap_phi_mux_last_block_phi_fu_178_p4;
wire    ap_loop_init;
reg   [7:0] localBits_idx_fu_94;
wire   [7:0] localBits_idx_16_fu_304_p2;
wire   [7:0] localBits_idx_15_fu_282_p2;
reg    ap_loop_exit_ready_pp0_iter1_reg;
reg   [31:0] localBits_fu_98;
wire   [31:0] zext_ln59_fu_444_p1;
wire   [31:0] localBits_9_fu_428_p2;
...
reg   [7:0] outValue_data_86_fu_106;
wire   [7:0] outValue_data_88_fu_448_p1;
reg   [7:0] outValue_data_87_fu_110;
reg    hufCodeStream_read_local;
wire   [17:0] tmp_s_fu_466_p3;
reg    ap_block_pp0_stage0_01001;
reg    huffStream_4_write_local;
wire   [3:0] tmp_221_fu_231_p4;
wire   [4:0] zext_ln54_7_fu_244_p1;
...
wire   [3:0] tmp_306_fu_288_p4;
wire   [14:0] trunc_ln50_fu_323_p1;
wire   [4:0] xor_ln54_fu_330_p2;
wire   [4:0] select_ln54_fu_335_p3;
wire   [4:0] select_ln54_11_fu_345_p3;
wire   [4:0] select_ln54_10_fu_340_p3;
wire   [4:0] xor_ln54_7_fu_351_p2;
wire   [31:0] zext_ln54_6_fu_326_p1;
wire   [31:0] zext_ln54_12_fu_357_p1;
wire   [31:0] shl_ln54_fu_369_p2;
reg   [31:0] tmp_305_fu_375_p4;
wire   [31:0] zext_ln54_13_fu_361_p1;
wire   [31:0] zext_ln54_14_fu_365_p1;
wire   [31:0] shl_ln54_4_fu_392_p2;
wire   [31:0] lshr_ln54_fu_398_p2;
wire   [31:0] and_ln54_fu_404_p2;
wire   [31:0] xor_ln54_8_fu_410_p2;
wire   [31:0] select_ln54_12_fu_385_p3;
wire   [31:0] and_ln54_7_fu_416_p2;
wire   [31:0] and_ln54_8_fu_422_p2;
wire   [15:0] localBits_7_fu_434_p4;
...
#0 outValue_data_86_fu_106 = 8'd0;
#0 outValue_data_87_fu_110 = 8'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            outValue_data_87_fu_110 <= {{localBits_9_fu_428_p2[15:8]}};
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (inValue_strobe_reg_556 == 1'd0))) begin
        outValue_data_125_out_ap_vld = 1'b1;
    end else begin
        outValue_data_125_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (inValue_strobe_reg_556 == 1'd0))) begin
        outValue_data_126_out_ap_vld = 1'b1;
    end else begin
        outValue_data_126_out_ap_vld = 1'b0;
    end
end
...
assign add_ln54_3_fu_262_p2 = ($signed(zext_ln54_fu_248_p1) + $signed(sext_ln54_fu_258_p1));

assign add_ln54_fu_252_p2 = ($signed(zext_ln54_7_fu_244_p1) + $signed(5'd31));

assign and_ln54_7_fu_416_p2 = (xor_ln54_8_fu_410_p2 & localBits_fu_98);

assign and_ln54_8_fu_422_p2 = (select_ln54_12_fu_385_p3 & and_ln54_fu_404_p2);

assign and_ln54_fu_404_p2 = (shl_ln54_4_fu_392_p2 & lshr_ln54_fu_398_p2);
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((icmp_ln57_reg_582 == 1'd0) & (huffStream_4_full_n == 1'b0));
end
...
assign huffStream_4_din = tmp_s_fu_466_p3;

assign huffStream_4_write = huffStream_4_write_local;

assign icmp_ln54_fu_268_p2 = ((zext_ln54_fu_248_p1 > add_ln54_3_fu_262_p2) ? 1'b1 : 1'b0);

assign icmp_ln57_fu_298_p2 = ((tmp_306_fu_288_p4 == 4'd0) ? 1'b1 : 1'b0);
...
assign localBits_7_fu_434_p4 = {{localBits_9_fu_428_p2[31:16]}};

assign localBits_9_fu_428_p2 = (and_ln54_8_fu_422_p2 | and_ln54_7_fu_416_p2);

assign localBits_idx_15_fu_282_p2 = (localBits_idx_fu_94 + zext_ln53_fu_240_p1);

assign localBits_idx_16_fu_304_p2 = ($signed(localBits_idx_15_fu_282_p2) + $signed(8'd240));

assign localBits_idx_out = localBits_idx_fu_94;

assign localBits_out = localBits_fu_98;

assign lshr_ln54_fu_398_p2 = 32'd4294967295 >> zext_ln54_14_fu_365_p1;

assign outValue_data_125_out = outValue_data_86_fu_106;

assign outValue_data_126_out = outValue_data_87_fu_110;

assign outValue_data_88_fu_448_p1 = localBits_9_fu_428_p2[7:0];

assign select_ln54_10_fu_340_p3 = ((icmp_ln54_reg_560[0:0] == 1'b1) ? trunc_ln54_4_reg_576 : trunc_ln54_reg_568);

assign select_ln54_11_fu_345_p3 = ((icmp_ln54_reg_560[0:0] == 1'b1) ? xor_ln54_fu_330_p2 : trunc_ln54_reg_568);

assign select_ln54_12_fu_385_p3 = ((icmp_ln54_reg_560[0:0] == 1'b1) ? tmp_305_fu_375_p4 : shl_ln54_fu_369_p2);

assign select_ln54_fu_335_p3 = ((icmp_ln54_reg_560[0:0] == 1'b1) ? trunc_ln54_reg_568 : trunc_ln54_4_reg_576);

assign sext_ln54_fu_258_p1 = $signed(add_ln54_fu_252_p2);

assign shl_ln54_4_fu_392_p2 = 32'd4294967295 << zext_ln54_13_fu_361_p1;

assign shl_ln54_fu_369_p2 = zext_ln54_6_fu_326_p1 << zext_ln54_12_fu_357_p1;

assign tmp_221_fu_231_p4 = {{inValue_data_bitlen_sroa_0_0_239_in_in_in_load_reg_550[18:15]}};
...
always @ (shl_ln54_fu_369_p2) begin
    for (ap_tvar_int_0 = 32 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 31 - 0) begin
            tmp_305_fu_375_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_305_fu_375_p4[ap_tvar_int_0] = shl_ln54_fu_369_p2[31 - ap_tvar_int_0];
        end
    end
end

assign tmp_306_fu_288_p4 = {{localBits_idx_15_fu_282_p2[7:4]}};
...
assign trunc_ln54_4_fu_278_p1 = add_ln54_3_fu_262_p2[4:0];

assign trunc_ln54_fu_274_p1 = localBits_idx_fu_94[4:0];

assign trunc_ln65_fu_462_p1 = localBits_9_fu_428_p2[15:0];

assign xor_ln54_7_fu_351_p2 = (select_ln54_fu_335_p3 ^ 5'd31);

assign xor_ln54_8_fu_410_p2 = (32'd4294967295 ^ and_ln54_fu_404_p2);

assign xor_ln54_fu_330_p2 = (trunc_ln54_reg_568 ^ 5'd31);

assign zext_ln53_fu_240_p1 = tmp_221_fu_231_p4;

assign zext_ln54_12_fu_357_p1 = select_ln54_11_fu_345_p3;

assign zext_ln54_13_fu_361_p1 = select_ln54_10_fu_340_p3;

assign zext_ln54_14_fu_365_p1 = xor_ln54_7_fu_351_p2;

assign zext_ln54_6_fu_326_p1 = trunc_ln50_fu_323_p1;

assign zext_ln54_7_fu_244_p1 = tmp_221_fu_231_p4;

assign zext_ln54_fu_248_p1 = localBits_idx_fu_94;

assign zext_ln59_fu_444_p1 = localBits_7_fu_434_p4;

endmodule //gzipcMulticoreStreaming_bitPackingStatic_36_Pipeline_bitpack
