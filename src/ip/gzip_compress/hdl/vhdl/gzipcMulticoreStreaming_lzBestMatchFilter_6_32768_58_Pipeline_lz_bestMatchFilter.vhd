...
entity gzipcMulticoreStreaming_lzBestMatchFilter_6_32768_58_Pipeline_lz_bestMatchFilter is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_lzBestMatchFilter_6_32768_58_Pipeline_lz_bestMatchFilter is 
...
attribute shreg_extract : string;
    ...
    signal outValue_data_12_fu_166_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal outValue_data_12_reg_214 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal nextVal_data_91_in_fu_60 : STD_LOGIC_VECTOR (32 downto 0) := "000000000000000000000000000000000";
    ...
    signal outValue_data_11_fu_154_p5 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    nextVal_data_91_in_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    nextVal_data_91_in_fu_60 <= empty;
                elsif (((nextVal_strobe_fu_117_p3 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    nextVal_data_91_in_fu_60 <= compressedStream_dout;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                outValue_data_12_reg_214 <= outValue_data_12_fu_166_p3;
            end if;
        end if;
    end process;
    ...
    compareLen_fu_138_p4 <= nextVal_data_91_in_fu_60(15 downto 8);
    ...
    nextVal_strobe_fu_117_p3 <= nextVal_data_91_in_fu_60(32 downto 32);
    outValue_data_11_fu_154_p5 <= (ap_const_lv24_0 & outValue_data_fu_64(7 downto 0));
    outValue_data_12_fu_166_p3 <= 
        outValue_data_11_fu_154_p5 when (icmp_ln396_fu_148_p2(0) = '1') else 
        outValue_data_fu_64;
    ...
    tmp_s_fu_184_p3 <= (ap_const_lv1_1 & outValue_data_12_reg_214);
    trunc_ln369_fu_113_p1 <= nextVal_data_91_in_fu_60(32 - 1 downto 0);
end behav;
