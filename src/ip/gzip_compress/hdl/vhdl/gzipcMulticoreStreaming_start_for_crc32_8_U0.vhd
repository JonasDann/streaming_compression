...
entity gzipcMulticoreStreaming_start_for_crc32_8_U0 is 
    generic (
...
architecture rtl of gzipcMulticoreStreaming_start_for_crc32_8_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component gzipcMulticoreStreaming_start_for_crc32_8_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
...
begin
----------------------- Instantiation -----------------------
    U_gzipcMulticoreStreaming_start_for_crc32_8_U0_ShiftReg : gzipcMulticoreStreaming_start_for_crc32_8_U0_ShiftReg
    generic map (
...
entity gzipcMulticoreStreaming_start_for_crc32_8_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end gzipcMulticoreStreaming_start_for_crc32_8_U0_ShiftReg;

architecture rtl of gzipcMulticoreStreaming_start_for_crc32_8_U0_ShiftReg is
