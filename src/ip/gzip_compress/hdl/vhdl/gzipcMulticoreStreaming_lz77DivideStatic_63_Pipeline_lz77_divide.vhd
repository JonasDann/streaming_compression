...
entity gzipcMulticoreStreaming_lz77DivideStatic_63_Pipeline_lz77_divide is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    just_started_2_out : OUT STD_LOGIC_VECTOR (0 downto 0);
    just_started_2_out_ap_vld : OUT STD_LOGIC );
end;


architecture behav of gzipcMulticoreStreaming_lz77DivideStatic_63_Pipeline_lz77_divide is 
...
attribute shreg_extract : string;
    ...
    signal next_state_2_reg_340 : STD_LOGIC_VECTOR (31 downto 0);
    signal next_state_2_reg_340_pp0_iter1_reg : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tOffset1_1_reg_358 : STD_LOGIC_VECTOR (7 downto 0);
    signal tOffset2_1_reg_363 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_171_fu_281_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal lz77Stream_1_write_local : STD_LOGIC;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                elsif (((next_state_2_reg_340 = ap_const_lv32_2) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    conv2_i_i164_fu_88 <= zext_ln290_fu_236_p1;
                elsif (((next_state_2_reg_340 = ap_const_lv32_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln275_reg_368 <= icmp_ln275_fu_205_p2;
                    next_state_2_reg_340(1 downto 0) <= ap_sig_allocacmp_next_state_2(1 downto 0);
                    next_state_2_reg_340_pp0_iter1_reg(1 downto 0) <= next_state_2_reg_340(1 downto 0);
                tCh_reg_348 <= tCh_fu_171_p1;
                tLen_reg_353 <= boosterStream_dout(15 downto 8);
                tOffset1_1_reg_358 <= boosterStream_dout(23 downto 16);
                tOffset2_1_reg_363 <= boosterStream_dout(31 downto 24);
            end if;
        end if;
    end process;
    next_state_2_reg_340(31 downto 2) <= "000000000000000000000000000000";
    next_state_2_reg_340_pp0_iter1_reg(31 downto 2) <= "000000000000000000000000000000";
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(lz77Stream_1_full_n, ap_predicate_op57_write_state3)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((ap_predicate_op57_write_state3 = ap_const_boolean_1) and (lz77Stream_1_full_n = ap_const_logic_0));
    end process;


    ap_condition_309_assign_proc : process(ap_enable_reg_pp0_iter1, encodedValue_strobe_reg_344, next_state_2_reg_340)
    begin
                ap_condition_309 <= (not((next_state_2_reg_340 = ap_const_lv32_1)) and not((next_state_2_reg_340 = ap_const_lv32_2)) and (encodedValue_strobe_reg_344 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_condition_310_assign_proc : process(ap_enable_reg_pp0_iter1, encodedValue_strobe_reg_344, next_state_2_reg_340, icmp_ln275_reg_368)
    begin
                ap_condition_310 <= (not((next_state_2_reg_340 = ap_const_lv32_1)) and not((next_state_2_reg_340 = ap_const_lv32_2)) and (encodedValue_strobe_reg_344 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln275_reg_368 = ap_const_lv1_0));
    end process;


    ap_condition_313_assign_proc : process(ap_enable_reg_pp0_iter1, encodedValue_strobe_reg_344, next_state_2_reg_340, icmp_ln275_reg_368)
    begin
                ap_condition_313 <= (not((next_state_2_reg_340 = ap_const_lv32_1)) and not((next_state_2_reg_340 = ap_const_lv32_2)) and (encodedValue_strobe_reg_344 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln275_reg_368 = ap_const_lv1_1));
    end process;


    ap_condition_321_assign_proc : process(encodedValue_strobe_fu_163_p3, icmp_ln275_fu_205_p2, ap_sig_allocacmp_next_state_2, ap_start_int)
    begin
                ap_condition_321 <= (not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_1)) and not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_2)) and (encodedValue_strobe_fu_163_p3 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (icmp_ln275_fu_205_p2 = ap_const_lv1_0));
    end process;


    ap_condition_324_assign_proc : process(encodedValue_strobe_fu_163_p3, icmp_ln275_fu_205_p2, ap_sig_allocacmp_next_state_2, ap_start_int)
    begin
                ap_condition_324 <= (not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_1)) and not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_2)) and (encodedValue_strobe_fu_163_p3 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (icmp_ln275_fu_205_p2 = ap_const_lv1_1));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, encodedValue_strobe_fu_163_p3, ap_sig_allocacmp_next_state_2, ap_start_int)
    begin
        if ((not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_1)) and not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_2)) and (encodedValue_strobe_fu_163_p3 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_predicate_op27_read_state1_assign_proc : process(ap_sig_allocacmp_next_state_2)
    begin
                ap_predicate_op27_read_state1 <= (not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_1)) and not((ap_sig_allocacmp_next_state_2 = ap_const_lv32_2)));
    end process;


    ap_predicate_op57_write_state3_assign_proc : process(encodedValue_strobe_reg_344_pp0_iter1_reg, next_state_2_reg_340_pp0_iter1_reg)
    begin
                ap_predicate_op57_write_state3 <= ((next_state_2_reg_340_pp0_iter1_reg = ap_const_lv32_2) or ((next_state_2_reg_340_pp0_iter1_reg = ap_const_lv32_1) or (encodedValue_strobe_reg_344_pp0_iter1_reg = ap_const_lv1_1)));
    end process;
    ...
    ap_sig_allocacmp_next_state_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, next_state_fu_84)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_next_state_2 <= ap_const_lv32_0_1;
        else 
            ap_sig_allocacmp_next_state_2 <= next_state_fu_84;
        end if; 
    end process;
    ...
    conv2_i_i164_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, encodedValue_strobe_reg_344, next_state_2_reg_340, ap_block_pp0_stage0_11001, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if ((not((next_state_2_reg_340 = ap_const_lv32_1)) and not((next_state_2_reg_340 = ap_const_lv32_2)) and (encodedValue_strobe_reg_344 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1))) then 
    ...
    just_started_2_out <= last_block_fu_72;

    just_started_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, encodedValue_strobe_reg_344, next_state_2_reg_340, ap_block_pp0_stage0_11001, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if ((not((next_state_2_reg_340 = ap_const_lv32_1)) and not((next_state_2_reg_340 = ap_const_lv32_2)) and (encodedValue_strobe_reg_344 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1))) then 
            just_started_2_out_ap_vld <= ap_const_logic_1;
        else 
            just_started_2_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;


    lz77Stream_1_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, lz77Stream_1_full_n, ap_predicate_op57_write_state3, ap_block_pp0_stage0)
    begin
    ...
    lz77Stream_1_din <= tmp_171_fu_281_p3;
    lz77Stream_1_write <= lz77Stream_1_write_local;

    lz77Stream_1_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_predicate_op57_write_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_predicate_op57_write_state3 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            lz77Stream_1_write_local <= ap_const_logic_1;
        else 
            lz77Stream_1_write_local <= ap_const_logic_0;
        end if; 
    end process;

    tCh_fu_171_p1 <= boosterStream_dout(8 - 1 downto 0);
    tLen_fu_175_p4 <= boosterStream_dout(15 downto 8);
    tmp_171_fu_281_p3 <= (ap_const_lv1_1 & conv2_i_i164_fu_88);
