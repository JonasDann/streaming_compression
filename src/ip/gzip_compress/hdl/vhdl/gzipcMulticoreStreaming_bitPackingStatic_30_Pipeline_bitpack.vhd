...
entity gzipcMulticoreStreaming_bitPackingStatic_30_Pipeline_bitpack is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_bitPackingStatic_30_Pipeline_bitpack is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln54_6_fu_278_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal trunc_ln54_6_reg_576 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal localBits_idx_28_fu_304_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal localBits_idx_27_fu_282_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal localBits_12_fu_428_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal outValue_data_102_fu_106 : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    signal outValue_data_104_fu_448_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal outValue_data_103_fu_110 : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    ...
    signal tmp_225_fu_231_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln54_11_fu_244_p1 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal add_ln54_5_fu_262_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln53_fu_240_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_312_fu_288_p4 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal select_ln54_17_fu_345_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal select_ln54_16_fu_340_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal xor_ln54_11_fu_351_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln54_10_fu_326_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln54_18_fu_357_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln54_fu_369_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_311_fu_375_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln54_19_fu_361_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln54_20_fu_365_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln54_6_fu_392_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal lshr_ln54_fu_398_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal and_ln54_fu_404_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal xor_ln54_12_fu_410_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln54_18_fu_385_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal and_ln54_11_fu_416_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal and_ln54_12_fu_422_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal localBits_13_fu_434_p4 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    localBits_fu_98 <= localBits_12_fu_428_p2;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    localBits_idx_fu_94 <= localBits_idx_27_fu_282_p2;
                elsif (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln57_fu_298_p2 = ap_const_lv1_0))) then 
                    localBits_idx_fu_94 <= localBits_idx_28_fu_304_p2;
                end if;
            end if; 
        end if;
    end process;

    outValue_data_102_fu_106_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    outValue_data_102_fu_106 <= ap_const_lv8_0;
                elsif (((icmp_ln57_reg_582 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
                    outValue_data_102_fu_106 <= outValue_data_104_fu_448_p1;
                end if;
            end if; 
        end if;
    end process;

    outValue_data_103_fu_110_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    outValue_data_103_fu_110 <= outValue_data;
                elsif (((icmp_ln57_reg_582 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
                    outValue_data_103_fu_110 <= localBits_12_fu_428_p2(15 downto 8);
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                trunc_ln54_6_reg_576 <= trunc_ln54_6_fu_278_p1;
    ...
    add_ln54_5_fu_262_p2 <= std_logic_vector(unsigned(zext_ln54_fu_248_p1) + unsigned(sext_ln54_fu_258_p1));
    add_ln54_fu_252_p2 <= std_logic_vector(unsigned(zext_ln54_11_fu_244_p1) + unsigned(ap_const_lv5_1F));
    and_ln54_11_fu_416_p2 <= (xor_ln54_12_fu_410_p2 and localBits_fu_98);
    and_ln54_12_fu_422_p2 <= (select_ln54_18_fu_385_p3 and and_ln54_fu_404_p2);
    and_ln54_fu_404_p2 <= (shl_ln54_6_fu_392_p2 and lshr_ln54_fu_398_p2);
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(huffStream_2_full_n, icmp_ln57_reg_582)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((icmp_ln57_reg_582 = ap_const_lv1_0) and (huffStream_2_full_n = ap_const_logic_0));
    end process;
    ...
    huffStream_2_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, huffStream_2_full_n, icmp_ln57_reg_582, ap_block_pp0_stage0)
    begin
    ...
    huffStream_2_din <= tmp_s_fu_466_p3;
    huffStream_2_write <= huffStream_2_write_local;

    huffStream_2_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln57_reg_582, ap_block_pp0_stage0_11001)
    begin
    ...
    icmp_ln54_fu_268_p2 <= "1" when (unsigned(zext_ln54_fu_248_p1) > unsigned(add_ln54_5_fu_262_p2)) else "0";
    icmp_ln57_fu_298_p2 <= "1" when (tmp_312_fu_288_p4 = ap_const_lv4_0) else "0";
    ...
    localBits_12_fu_428_p2 <= (and_ln54_12_fu_422_p2 or and_ln54_11_fu_416_p2);
    localBits_13_fu_434_p4 <= localBits_12_fu_428_p2(31 downto 16);
    localBits_idx_27_fu_282_p2 <= std_logic_vector(unsigned(localBits_idx_fu_94) + unsigned(zext_ln53_fu_240_p1));
    localBits_idx_28_fu_304_p2 <= std_logic_vector(unsigned(localBits_idx_27_fu_282_p2) + unsigned(ap_const_lv8_F0));
    ...
    lshr_ln54_fu_398_p2 <= std_logic_vector(shift_right(unsigned(ap_const_lv32_FFFFFFFF),to_integer(unsigned('0' & zext_ln54_20_fu_365_p1(31-1 downto 0)))));
    outValue_data_104_fu_448_p1 <= localBits_12_fu_428_p2(8 - 1 downto 0);
    outValue_data_145_out <= outValue_data_102_fu_106;

    outValue_data_145_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, inValue_strobe_reg_556, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (inValue_strobe_reg_556 = ap_const_lv1_0))) then 
            outValue_data_145_out_ap_vld <= ap_const_logic_1;
        else 
            outValue_data_145_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    outValue_data_146_out <= outValue_data_103_fu_110;

    outValue_data_146_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, inValue_strobe_reg_556, ap_loop_exit_ready_pp0_iter1_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (inValue_strobe_reg_556 = ap_const_lv1_0))) then 
            outValue_data_146_out_ap_vld <= ap_const_logic_1;
        else 
            outValue_data_146_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    select_ln54_16_fu_340_p3 <= 
        trunc_ln54_6_reg_576 when (icmp_ln54_reg_560(0) = '1') else 
        trunc_ln54_reg_568;
    select_ln54_17_fu_345_p3 <= 
        xor_ln54_fu_330_p2 when (icmp_ln54_reg_560(0) = '1') else 
        trunc_ln54_reg_568;
    select_ln54_18_fu_385_p3 <= 
        tmp_311_fu_375_p4 when (icmp_ln54_reg_560(0) = '1') else 
        shl_ln54_fu_369_p2;
    select_ln54_fu_335_p3 <= 
        trunc_ln54_reg_568 when (icmp_ln54_reg_560(0) = '1') else 
        trunc_ln54_6_reg_576;
        sext_ln54_fu_258_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln54_fu_252_p2),10));

    shl_ln54_6_fu_392_p2 <= std_logic_vector(shift_left(unsigned(ap_const_lv32_FFFFFFFF),to_integer(unsigned('0' & zext_ln54_19_fu_361_p1(31-1 downto 0)))));
    shl_ln54_fu_369_p2 <= std_logic_vector(shift_left(unsigned(zext_ln54_10_fu_326_p1),to_integer(unsigned('0' & zext_ln54_18_fu_357_p1(31-1 downto 0)))));
    tmp_225_fu_231_p4 <= inValue_data_bitlen_sroa_0_0_239_in_in_in_load_reg_550(18 downto 15);
    
    tmp_311_fu_375_p4_proc : process(shl_ln54_fu_369_p2)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_311_fu_375_p4_i : integer;
    ...
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            ...
            for tmp_311_fu_375_p4_i in 0 to 32-1 loop
                v0_cpy(tmp_311_fu_375_p4_i) := shl_ln54_fu_369_p2(32-1-tmp_311_fu_375_p4_i);
            end loop;
        end if;
        ...
        tmp_311_fu_375_p4 <= resvalue(32-1 downto 0);
    end process;

    tmp_312_fu_288_p4 <= localBits_idx_27_fu_282_p2(7 downto 4);
    ...
    trunc_ln54_6_fu_278_p1 <= add_ln54_5_fu_262_p2(5 - 1 downto 0);
    trunc_ln54_fu_274_p1 <= localBits_idx_fu_94(5 - 1 downto 0);
    trunc_ln65_fu_462_p1 <= localBits_12_fu_428_p2(16 - 1 downto 0);
    xor_ln54_11_fu_351_p2 <= (select_ln54_fu_335_p3 xor ap_const_lv5_1F);
    xor_ln54_12_fu_410_p2 <= (ap_const_lv32_FFFFFFFF xor and_ln54_fu_404_p2);
    xor_ln54_fu_330_p2 <= (trunc_ln54_reg_568 xor ap_const_lv5_1F);
    zext_ln53_fu_240_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_225_fu_231_p4),8));
    zext_ln54_10_fu_326_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln50_fu_323_p1),32));
    zext_ln54_11_fu_244_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_225_fu_231_p4),5));
    zext_ln54_18_fu_357_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln54_17_fu_345_p3),32));
    zext_ln54_19_fu_361_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln54_16_fu_340_p3),32));
    zext_ln54_20_fu_365_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(xor_ln54_11_fu_351_p2),32));
    zext_ln54_fu_248_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(localBits_idx_fu_94),10));
    zext_ln59_fu_444_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(localBits_13_fu_434_p4),32));
end behav;
