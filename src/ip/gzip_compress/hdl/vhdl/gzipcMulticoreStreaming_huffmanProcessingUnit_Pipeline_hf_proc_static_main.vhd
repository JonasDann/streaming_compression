...
attribute shreg_extract : string;
    ...
    signal outValue_data_24_fu_199_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal outValue_data_26_fu_251_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal done_233_fu_303_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal done_233_reg_383 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_phi_reg_pp0_iter0_outValue_data_27_reg_124 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter1_outValue_data_27_reg_124 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter2_outValue_data_27_reg_124 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal outValue_data_23_fu_220_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal outValue_data_25_fu_281_p5 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_phi_reg_pp0_iter2_outValue_data_27_reg_124_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_119)) then
                if ((ap_const_boolean_1 = ap_condition_141)) then 
                    ap_phi_reg_pp0_iter2_outValue_data_27_reg_124 <= outValue_data_26_fu_251_p5;
                elsif (((ap_phi_mux_done_phi_fu_116_p4 = ap_const_lv1_0) and (next_state_load_load_fu_172_p1 = ap_const_lv32_3))) then 
                    ap_phi_reg_pp0_iter2_outValue_data_27_reg_124 <= outValue_data_24_fu_199_p5;
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    ap_phi_reg_pp0_iter2_outValue_data_27_reg_124 <= ap_phi_reg_pp0_iter1_outValue_data_27_reg_124;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_phi_mux_done_phi_fu_116_p4 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tokenFlag_fu_175_p3 = ap_const_lv1_1) and (next_state_load_load_fu_172_p1 = ap_const_lv32_0))) then 
                outValue_data_fu_82 <= outValue_data_25_fu_281_p5;
            elsif ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (((ap_phi_mux_done_phi_fu_116_p4 = ap_const_lv1_0) and (tokenFlag_fu_175_p3 = ap_const_lv1_0) and (next_state_load_load_fu_172_p1 = ap_const_lv32_0)) or ((ap_phi_mux_done_phi_fu_116_p4 = ap_const_lv1_0) and (next_state_load_load_fu_172_p1 = ap_const_lv32_3)))) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1)))) then 
                outValue_data_fu_82 <= ap_const_lv32_0;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_phi_mux_done_phi_fu_116_p4 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (next_state_load_load_fu_172_p1 = ap_const_lv32_2))) then 
                outValue_data_fu_82 <= outValue_data_23_fu_220_p5;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ap_phi_reg_pp0_iter1_outValue_data_27_reg_124 <= ap_phi_reg_pp0_iter0_outValue_data_27_reg_124;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                done_233_reg_383 <= done_233_fu_303_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(lz77Stream_7_empty_n, ap_phi_mux_done_phi_fu_116_p4)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_phi_mux_done_phi_fu_116_p4 = ap_const_lv1_0) and (lz77Stream_7_empty_n = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_done_phi_fu_116_p4_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0, done_reg_112, done_233_reg_383)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (done_reg_112 = ap_const_lv1_0))) then 
            ap_phi_mux_done_phi_fu_116_p4 <= done_233_reg_383;
        else 
            ap_phi_mux_done_phi_fu_116_p4 <= done_reg_112;
        end if; 
    end process;

    ap_phi_reg_pp0_iter0_outValue_data_27_reg_124 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ...
    done_233_fu_303_p2 <= (nextValue_strobe_fu_187_p3 xor ap_const_lv1_1);
    ...
    lz77Stream_7_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, lz77Stream_7_empty_n, ap_phi_mux_done_phi_fu_116_p4, ap_block_pp0_stage0)
    begin
    ...
    lz77Stream_7_read_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_phi_mux_done_phi_fu_116_p4, ap_block_pp0_stage0_11001)
    begin
    ...
    nextValue_strobe_fu_187_p3 <= lz77Stream_7_dout(9 downto 9);
    next_state_load_load_fu_172_p1 <= next_state_fu_78;
    outValue_data_23_fu_220_p5 <= (outValue_data_fu_82(31 downto 24) & trunc_ln257_fu_216_p1 & outValue_data_fu_82(15 downto 0));
    outValue_data_24_fu_199_p5 <= (trunc_ln262_fu_195_p1 & outValue_data_fu_82(23 downto 0));
    outValue_data_25_fu_281_p5 <= (outValue_data_fu_82(31 downto 16) & tmp_fu_273_p3);
    outValue_data_26_fu_251_p5 <= (outValue_data_fu_82(31 downto 8) & trunc_ln247_fu_247_p1);
    outValue_data_98_out <= outValue_data_fu_82;

    outValue_data_98_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_phi_mux_done_phi_fu_116_p4, ap_loop_exit_ready, ap_block_pp0_stage0_11001)
    begin
        if (((ap_loop_exit_ready = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_phi_mux_done_phi_fu_116_p4 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            outValue_data_98_out_ap_vld <= ap_const_logic_1;
        else 
            outValue_data_98_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    tmp_fu_273_p3 <= (trunc_ln247_fu_247_p1 & ap_const_lv8_0);
    tmp_s_fu_317_p3 <= (outValue_strobe_fu_74 & ap_phi_reg_pp0_iter2_outValue_data_27_reg_124);
    tokenFlag_fu_175_p3 <= zext_ln222_fu_168_p1(8 downto 8);
    trunc_ln242_fu_183_p1 <= lz77Stream_7_dout(9 - 1 downto 0);
