...
entity gzipcMulticoreStreaming_huffmanEncoderStatic_38 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_huffmanEncoderStatic_38 is 
...
attribute shreg_extract : string;
    ...
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start : STD_LOGIC;
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_done : STD_LOGIC;
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_idle : STD_LOGIC;
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_ready : STD_LOGIC;
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_encodedOutStream_read : STD_LOGIC;
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_hufCodeStream_din : STD_LOGIC_VECTOR (19 downto 0);
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_hufCodeStream_write : STD_LOGIC;
    signal grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start_reg : STD_LOGIC := '0';
    ...
    component gzipcMulticoreStreaming_huffmanEncoderStatic_38_Pipeline_huffman_loop IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72 : component gzipcMulticoreStreaming_huffmanEncoderStatic_38_Pipeline_huffman_loop
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (ap_const_logic_1 = ap_NS_fsm_state3))) then 
                    grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_ready = ap_const_logic_1)) then 
                    grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, hufCodeStream_full_n, ap_CS_fsm_state2, nextEncodedValue_strobe_fu_101_p3, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_block_state2, grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_done, ap_CS_fsm_state4, ap_block_state1)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_done)
    begin
        if ((grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_done = ap_const_logic_0)) then 
    ...
    encodedOutStream_read_assign_proc : process(grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_encodedOutStream_read, ap_CS_fsm_state4, encodedOutStream_read_local)
    begin
    ...
    grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start <= grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_ap_start_reg;
    ...
    hufCodeStream_din_assign_proc : process(grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_hufCodeStream_din, ap_CS_fsm_state4, hufCodeStream_din_local)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            hufCodeStream_din <= grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_hufCodeStream_din;
        else 
    ...
    hufCodeStream_write_assign_proc : process(grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_hufCodeStream_write, ap_CS_fsm_state4, hufCodeStream_write_local)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            hufCodeStream_write <= grp_huffmanEncoderStatic_38_Pipeline_huffman_loop_fu_72_hufCodeStream_write;
        else 
