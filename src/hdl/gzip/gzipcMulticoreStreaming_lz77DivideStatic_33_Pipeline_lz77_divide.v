...
module gzipcMulticoreStreaming_lz77DivideStatic_33_Pipeline_lz77_divide (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    ap_loop_init;
reg   [7:0] tOffset1_5_fu_76;
reg   [7:0] tOffset2_5_fu_80;
reg   [31:0] next_state_fu_84;
wire   [0:0] icmp_ln275_fu_229_p2;
reg   [8:0] p_Result_29_fu_88;
wire   [8:0] zext_ln257_fu_156_p1;
wire   [8:0] zext_ln257_7_fu_173_p1;
wire   [8:0] p_Result_s_fu_250_p3;
wire   [8:0] zext_ln257_8_fu_268_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            tOffset1_5_fu_76 <= 8'd0;
        end else if ((1'b1 == ap_condition_258)) begin
            tOffset1_5_fu_76 <= {{boosterStream_dout[23:16]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            tOffset2_5_fu_80 <= 8'd0;
        end else if ((1'b1 == ap_condition_258)) begin
            tOffset2_5_fu_80 <= {{boosterStream_dout[31:24]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        next_state_5_reg_344[1 : 0] <= next_state_fu_84[1 : 0];
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_predicate_op56_write_state3 == 1'b1) & (lz77Stream_4_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op34_read_state2 == 1'b1) & (boosterStream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_predicate_op56_write_state3 == 1'b1) & (lz77Stream_4_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op34_read_state2 == 1'b1) & (boosterStream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_predicate_op56_write_state3 == 1'b1) & (lz77Stream_4_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op34_read_state2 == 1'b1) & (boosterStream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((ap_predicate_op56_write_state3 == 1'b1) & (lz77Stream_4_full_n == 1'b0));
end
...
always @ (*) begin
    ap_predicate_op56_write_state3 = ((next_state_5_reg_344 == 32'd2) | ((next_state_5_reg_344 == 32'd1) | (tmp_strobe_V_reg_348 == 1'd1)));
end

assign conv2_i_i225_out = p_Result_29_fu_88;

assign icmp_ln275_fu_229_p2 = ((tLen_fu_199_p4 == 8'd0) ? 1'b1 : 1'b0);

assign just_started_1_out = just_started_fu_72;

assign lz77Stream_4_din = {{1'd1}, {p_Result_29_fu_88}};
...
assign zext_ln257_7_fu_173_p1 = tOffset2_5_fu_80;

assign zext_ln257_8_fu_268_p1 = tCh_fu_195_p1;

assign zext_ln257_fu_156_p1 = tOffset1_5_fu_76;

always @ (posedge ap_clk) begin
    next_state_5_reg_344[31:2] <= 30'b000000000000000000000000000000;
    next_state_fu_84[31:2] <= 30'b000000000000000000000000000000;
end

endmodule //gzipcMulticoreStreaming_lz77DivideStatic_33_Pipeline_lz77_divide
