...
module gzipcMulticoreStreaming_bitPackingStatic_63_Pipeline_bitpack (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        empty,
        outValue_data_V,
        outValue_data_V_130_out,
        outValue_data_V_130_out_ap_vld,
        outValue_data_V_129_out,
        outValue_data_V_129_out_ap_vld,
        localBits_V_4_out,
        localBits_V_4_out_ap_vld,
        last_block_out,
...
output  [7:0] outValue_data_V_130_out;
output   outValue_data_V_130_out_ap_vld;
output  [7:0] outValue_data_V_129_out;
output   outValue_data_V_129_out_ap_vld;
output  [31:0] localBits_V_4_out;
output   localBits_V_4_out_ap_vld;
...
reg outValue_data_V_130_out_ap_vld;
reg outValue_data_V_129_out_ap_vld;
reg localBits_V_4_out_ap_vld;
...
wire   [5:0] trunc_ln390_2_fu_284_p1;
reg   [5:0] trunc_ln390_2_reg_585;
...
wire   [7:0] localBits_idx_5_fu_310_p2;
wire   [7:0] localBits_idx_4_fu_288_p2;
...
reg   [7:0] outValue_data_V_48_fu_108;
wire   [7:0] outValue_data_V_50_fu_459_p1;
reg   [7:0] outValue_data_V_49_fu_112;
...
wire   [3:0] tmp_276_fu_294_p4;
wire   [14:0] tmp_277_fu_334_p1;
wire   [5:0] sub_ln390_fu_341_p2;
wire   [5:0] select_ln390_fu_346_p3;
wire   [5:0] select_ln390_5_fu_356_p3;
wire   [5:0] select_ln390_4_fu_351_p3;
wire   [5:0] sub_ln390_2_fu_362_p2;
wire   [31:0] zext_ln259_fu_337_p1;
wire   [31:0] zext_ln390_fu_368_p1;
wire   [31:0] shl_ln390_fu_380_p2;
reg   [31:0] tmp_275_fu_386_p4;
wire   [31:0] zext_ln390_3_fu_372_p1;
wire   [31:0] zext_ln390_4_fu_376_p1;
wire   [31:0] shl_ln390_2_fu_403_p2;
wire   [31:0] lshr_ln390_fu_409_p2;
wire   [31:0] and_ln390_fu_415_p2;
wire   [31:0] xor_ln390_fu_421_p2;
wire   [31:0] select_ln390_6_fu_396_p3;
wire   [31:0] and_ln390_3_fu_427_p2;
wire   [31:0] and_ln390_4_fu_433_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            outValue_data_V_48_fu_108 <= 8'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            outValue_data_V_49_fu_112 <= {{p_Result_s_fu_439_p2[15:8]}};
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (inValue_strobe_V_reg_565 == 1'd0))) begin
        localBits_V_4_out_ap_vld = 1'b1;
    end else begin
        localBits_V_4_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (inValue_strobe_V_reg_565 == 1'd0))) begin
        outValue_data_V_129_out_ap_vld = 1'b1;
    end else begin
        outValue_data_V_129_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (inValue_strobe_V_reg_565 == 1'd0))) begin
        outValue_data_V_130_out_ap_vld = 1'b1;
    end else begin
        outValue_data_V_130_out_ap_vld = 1'b0;
    end
end
...
assign and_ln390_3_fu_427_p2 = (xor_ln390_fu_421_p2 & p_Val2_s_fu_100);

assign and_ln390_4_fu_433_p2 = (select_ln390_6_fu_396_p3 & and_ln390_fu_415_p2);

assign and_ln390_fu_415_p2 = (shl_ln390_2_fu_403_p2 & lshr_ln390_fu_409_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln57_reg_591_pp0_iter1_reg == 1'd0) & (huffStream_7_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((inValue_strobe_V_fu_217_p3 == 1'd1) & (hufCodeStream_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln57_reg_591_pp0_iter1_reg == 1'd0) & (huffStream_7_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((inValue_strobe_V_fu_217_p3 == 1'd1) & (hufCodeStream_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln57_reg_591_pp0_iter1_reg == 1'd0) & (huffStream_7_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((inValue_strobe_V_fu_217_p3 == 1'd1) & (hufCodeStream_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((icmp_ln57_reg_591_pp0_iter1_reg == 1'd0) & (huffStream_7_full_n == 1'b0));
end
...
assign huffStream_7_din = {{2'd2}, {trunc_ln174_reg_595}};

assign icmp_ln390_fu_274_p2 = ((zext_ln54_1_fu_242_p1 > sext_ln259_fu_270_p1) ? 1'b1 : 1'b0);

assign icmp_ln57_fu_304_p2 = ((tmp_276_fu_294_p4 == 4'd0) ? 1'b1 : 1'b0);
...
assign localBits_V_4_out = p_Val2_s_fu_100;

assign localBits_idx_4_fu_288_p2 = (ap_sig_allocacmp_localBits_idx_load + zext_ln54_3_fu_250_p1);

assign localBits_idx_5_fu_310_p2 = ($signed(localBits_idx_4_fu_288_p2) + $signed(8'd240));

assign localBits_idx_out = localBits_idx_fu_96;

assign lshr_ln390_fu_409_p2 = 32'd4294967295 >> zext_ln390_4_fu_376_p1;

assign outValue_data_V_129_out = outValue_data_V_48_fu_108;

assign outValue_data_V_130_out = outValue_data_V_49_fu_112;

assign outValue_data_V_50_fu_459_p1 = p_Result_s_fu_439_p2[7:0];

assign p_Result_s_fu_439_p2 = (and_ln390_4_fu_433_p2 | and_ln390_3_fu_427_p2);

assign select_ln390_4_fu_351_p3 = ((icmp_ln390_reg_569[0:0] == 1'b1) ? trunc_ln390_2_reg_585 : trunc_ln390_reg_577);

assign select_ln390_5_fu_356_p3 = ((icmp_ln390_reg_569[0:0] == 1'b1) ? sub_ln390_fu_341_p2 : trunc_ln390_reg_577);

assign select_ln390_6_fu_396_p3 = ((icmp_ln390_reg_569[0:0] == 1'b1) ? tmp_275_fu_386_p4 : shl_ln390_fu_380_p2);

assign select_ln390_fu_346_p3 = ((icmp_ln390_reg_569[0:0] == 1'b1) ? trunc_ln390_reg_577 : trunc_ln390_2_reg_585);

assign sext_ln259_fu_270_p1 = add_ln54_1_fu_264_p2;

assign shl_ln390_2_fu_403_p2 = 32'd4294967295 << zext_ln390_3_fu_372_p1;

assign shl_ln390_fu_380_p2 = zext_ln259_fu_337_p1 << zext_ln390_fu_368_p1;

assign sub_ln390_2_fu_362_p2 = (6'd31 - select_ln390_fu_346_p3);
...
always @ (shl_ln390_fu_380_p2) begin
    for (ap_tvar_int_0 = 32 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 31 - 0) begin
            tmp_275_fu_386_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_275_fu_386_p4[ap_tvar_int_0] = shl_ln390_fu_380_p2[31 - ap_tvar_int_0];
        end
    end
end

assign tmp_276_fu_294_p4 = {{localBits_idx_4_fu_288_p2[7:4]}};

assign tmp_277_fu_334_p1 = inValue_data_bitlen_sroa_0_0_391_in_in_in_load_reg_560[14:0];

assign trunc_ln174_fu_473_p1 = p_Result_s_fu_439_p2[15:0];

assign trunc_ln390_2_fu_284_p1 = add_ln54_1_fu_264_p2[5:0];
...
assign zext_ln259_fu_337_p1 = tmp_277_fu_334_p1;

assign zext_ln390_3_fu_372_p1 = select_ln390_4_fu_351_p3;

assign zext_ln390_4_fu_376_p1 = sub_ln390_2_fu_362_p2;

assign zext_ln390_fu_368_p1 = select_ln390_5_fu_356_p3;
...
endmodule //gzipcMulticoreStreaming_bitPackingStatic_63_Pipeline_bitpack
