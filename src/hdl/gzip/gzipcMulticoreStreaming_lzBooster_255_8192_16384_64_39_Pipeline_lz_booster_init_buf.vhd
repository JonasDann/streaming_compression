...
entity gzipcMulticoreStreaming_lzBooster_255_8192_16384_64_39_Pipeline_lz_booster_init_buf is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_lzBooster_255_8192_16384_64_39_Pipeline_lz_booster_init_buf is 
...
attribute shreg_extract : string;
    ...
    signal tmp_data_V_66_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_data_V_67_fu_135_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal i_fu_64 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln461_fu_120_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_sig_allocacmp_i_54 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    tmp_data_V_66_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln461_fu_120_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_54) + unsigned(ap_const_lv7_1));
    ...
    ap_sig_allocacmp_i_54_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_fu_64)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_54 <= ap_const_lv7_0;
        else 
            ap_sig_allocacmp_i_54 <= i_fu_64;
        end if; 
    end process;
    ...
    icmp_ln461_fu_114_p2 <= "1" when (ap_sig_allocacmp_i_54 = ap_const_lv7_40) else "0";
    ...
    lclBufStream_din <= tmp_data_V_66_fu_60;
    ...
    tmp_data_V_53_out <= tmp_data_V_66_fu_60;

    tmp_data_V_53_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln461_fu_114_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln461_fu_114_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    tmp_data_V_67_fu_135_p1 <= compressedStream1_dout(32 - 1 downto 0);
end behav;
