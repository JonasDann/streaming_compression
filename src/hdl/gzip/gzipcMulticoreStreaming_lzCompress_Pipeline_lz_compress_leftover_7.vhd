...
begin
    mux_63_8_1_1_U240 : component gzipcMulticoreStreaming_mux_63_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    port map (
        din0 => ap_const_lv8_0,
        din1 => present_window_160_reload,
        din2 => present_window_159_reload,
        din3 => present_window_158_reload,
        din4 => present_window_157_reload,
        din5 => present_window_156_reload,
    ...
    add_ln349_fu_147_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_m_1) + unsigned(ap_const_lv3_1));
    ...
    ap_sig_allocacmp_m_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, m_fu_62)
    begin
    ...
    icmp_ln349_fu_123_p2 <= "1" when (ap_sig_allocacmp_m_1 = ap_const_lv3_6) else "0";
    outValue_data_V_54_out <= p_Val2_s_fu_58;

    outValue_data_V_54_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln349_fu_123_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln349_fu_123_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            outValue_data_V_54_out_ap_vld <= ap_const_logic_1;
        else 
            outValue_data_V_54_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
