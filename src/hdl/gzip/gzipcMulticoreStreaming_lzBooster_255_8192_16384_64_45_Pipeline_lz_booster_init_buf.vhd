...
entity gzipcMulticoreStreaming_lzBooster_255_8192_16384_64_45_Pipeline_lz_booster_init_buf is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_lzBooster_255_8192_16384_64_45_Pipeline_lz_booster_init_buf is 
...
attribute shreg_extract : string;
    ...
    signal tmp_data_V_57_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_data_V_58_fu_135_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal i_fu_64 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln461_fu_120_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_sig_allocacmp_i_51 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    tmp_data_V_57_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln461_fu_120_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_51) + unsigned(ap_const_lv7_1));
    ...
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_51 <= ap_const_lv7_0;
        else 
    ...
    icmp_ln461_fu_114_p2 <= "1" when (ap_sig_allocacmp_i_51 = ap_const_lv7_40) else "0";
    ...
    lclBufStream_din <= tmp_data_V_57_fu_60;
    ...
    tmp_data_V_41_out <= tmp_data_V_57_fu_60;

    tmp_data_V_41_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln461_fu_114_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln461_fu_114_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            tmp_data_V_41_out_ap_vld <= ap_const_logic_1;
        else 
            tmp_data_V_41_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    tmp_data_V_58_fu_135_p1 <= compressedStream1_dout(32 - 1 downto 0);
end behav;
