...
entity gzipcMulticoreStreaming_bufferDownsizer_64_8_4_2_Pipeline_downsizer_assign is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_bufferDownsizer_64_8_4_2_Pipeline_downsizer_assign is 
...
attribute shreg_extract : string;
    ...
    signal inVal_V_40_reg_322 : STD_LOGIC_VECTOR (67 downto 0);
    signal dsize_V_fu_72 : STD_LOGIC_VECTOR (3 downto 0);
    signal dsize_V_24_fu_180_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal p_Val2_s_fu_76 : STD_LOGIC_VECTOR (67 downto 0);
    signal zext_ln1044_fu_247_p1 : STD_LOGIC_VECTOR (67 downto 0);
    signal outVal_data_V_42_fu_80 : STD_LOGIC_VECTOR (7 downto 0);
    signal outVal_data_V_43_fu_227_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal outSizeV_V_fu_84 : STD_LOGIC_VECTOR (34 downto 0);
    signal zext_ln1541_9_fu_205_p1 : STD_LOGIC_VECTOR (34 downto 0);
    signal zext_ln1541_cast_fu_136_p1 : STD_LOGIC_VECTOR (34 downto 0);
    signal inSize_V_16_fu_88 : STD_LOGIC_VECTOR (3 downto 0);
    signal inSize_V_23_fu_201_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    inSize_V_16_fu_88_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                                        ...
                                        outSizeV_V_fu_84(3 downto 0) <= zext_ln1541_9_fu_205_p1(3 downto 0);
                end if;
            end if; 
        end if;
    end process;

    outVal_data_V_42_fu_80_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    outVal_data_V_42_fu_80 <= p_Val2_s_fu_76(11 downto 4);
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    p_Val2_s_fu_76 <= inVal_V_40_reg_322;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op34_read_state2 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                inVal_V_40_reg_322 <= distStream_2_dout;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, distStream_2_empty_n, ap_predicate_op34_read_state2, downStream_2_full_n)
    begin
                ap_block_pp0_stage0_01001 <= (((downStream_2_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_predicate_op34_read_state2 = ap_const_boolean_1) and (distStream_2_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, distStream_2_empty_n, ap_predicate_op34_read_state2, downStream_2_full_n)
    begin
                ap_block_pp0_stage0_11001 <= (((downStream_2_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_predicate_op34_read_state2 = ap_const_boolean_1) and (distStream_2_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, distStream_2_empty_n, ap_predicate_op34_read_state2, downStream_2_full_n)
    begin
                ap_block_pp0_stage0_subdone <= (((downStream_2_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_predicate_op34_read_state2 = ap_const_boolean_1) and (distStream_2_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(distStream_2_empty_n, ap_predicate_op34_read_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_predicate_op34_read_state2 = ap_const_boolean_1) and (distStream_2_empty_n = ap_const_logic_0));
    end process;


    ap_block_state3_pp0_stage0_iter2_assign_proc : process(downStream_2_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (downStream_2_full_n = ap_const_logic_0);
    end process;
    ...
    distStream_2_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, distStream_2_empty_n, ap_predicate_op34_read_state2, ap_block_pp0_stage0)
    begin
    ...
    distStream_2_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op34_read_state2, ap_block_pp0_stage0_11001)
    begin
    ...
    downStream_2_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, downStream_2_full_n, ap_block_pp0_stage0)
    begin
    ...
    downStream_2_din <= (ap_const_lv1_1 & outVal_data_V_43_fu_227_p4);

    downStream_2_write_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
    ...
    dsize_V_24_fu_180_p2 <= std_logic_vector(unsigned(dsize_V_fu_72) + unsigned(ap_const_lv4_1));
    icmp_ln1065_fu_190_p2 <= "1" when (zext_ln1065_fu_186_p1 = outSizeV_V_fu_84) else "0";
    icmp_ln1081_fu_168_p2 <= "1" when (inSize_V_16_fu_88 = ap_const_lv4_0) else "0";
    inSize_V_23_fu_201_p1 <= distStream_2_dout(4 - 1 downto 0);
    inVal_V_fu_237_p4 <= p_Val2_s_fu_76(67 downto 8);
    outVal_data_V_42_out <= outVal_data_V_42_fu_80;

    outVal_data_V_42_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1081_fu_168_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln1081_fu_168_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            outVal_data_V_42_out_ap_vld <= ap_const_logic_1;
        else 
            outVal_data_V_42_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    outVal_data_V_43_fu_227_p4 <= p_Val2_s_fu_76(11 downto 4);
    zext_ln1044_fu_247_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(inVal_V_fu_237_p4),68));
    zext_ln1065_fu_186_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(dsize_V_24_fu_180_p2),35));
    zext_ln1541_9_fu_205_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(inSize_V_23_fu_201_p1),35));
