...
entity gzipcMulticoreStreaming_sendProcTrees_outCodes_RAM_1WNR_AUTO_1R1W is 
    generic(
            MEM_TYPE    : string := "auto"; 
            DataWidth     : integer := 20; 
            AddressWidth     : integer := 9; 
            AddressRange    : integer := 337
    ); 
    port (
...
architecture rtl of gzipcMulticoreStreaming_sendProcTrees_outCodes_RAM_1WNR_AUTO_1R1W is 
