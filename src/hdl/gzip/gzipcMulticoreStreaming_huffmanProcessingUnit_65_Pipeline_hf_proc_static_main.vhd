...
entity gzipcMulticoreStreaming_huffmanProcessingUnit_65_Pipeline_hf_proc_static_main is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_huffmanProcessingUnit_65_Pipeline_hf_proc_static_main is 
...
attribute shreg_extract : string;
    ...
    signal p_Result_47_fu_183_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_46_fu_235_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter0_outValue_data_V_20_reg_112 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter1_outValue_data_V_20_reg_112 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter2_outValue_data_V_20_reg_112 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal p_Result_45_fu_204_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_s_fu_265_p5 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal trunc_ln414_3_fu_179_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    ap_phi_reg_pp0_iter2_outValue_data_V_20_reg_112_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_124)) then
                if ((next_state_load_load_fu_156_p1 = ap_const_lv32_3)) then 
                    ap_phi_reg_pp0_iter2_outValue_data_V_20_reg_112 <= p_Result_47_fu_183_p5;
                elsif (((tokenFlag_fu_159_p3 = ap_const_lv1_0) and (next_state_load_load_fu_156_p1 = ap_const_lv32_0))) then 
                    ap_phi_reg_pp0_iter2_outValue_data_V_20_reg_112 <= p_Result_46_fu_235_p5;
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    ap_phi_reg_pp0_iter2_outValue_data_V_20_reg_112 <= ap_phi_reg_pp0_iter1_outValue_data_V_20_reg_112;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tokenFlag_fu_159_p3 = ap_const_lv1_1) and (next_state_load_load_fu_156_p1 = ap_const_lv32_0))) then 
                ...
                p_Val2_s_fu_82 <= p_Result_45_fu_204_p5;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ap_phi_reg_pp0_iter1_outValue_data_V_20_reg_112 <= ap_phi_reg_pp0_iter0_outValue_data_V_20_reg_112;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tmp_strobe_V_reg_351 <= lz77DownsizedStream_6_dout(9 downto 9);
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, lz77DownsizedStream_6_empty_n, encodedOutStream_full_n, ap_predicate_op59_write_state3)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_predicate_op59_write_state3 = ap_const_boolean_1) and (encodedOutStream_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((lz77DownsizedStream_6_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, lz77DownsizedStream_6_empty_n, encodedOutStream_full_n, ap_predicate_op59_write_state3)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_predicate_op59_write_state3 = ap_const_boolean_1) and (encodedOutStream_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((lz77DownsizedStream_6_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, lz77DownsizedStream_6_empty_n, encodedOutStream_full_n, ap_predicate_op59_write_state3)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_predicate_op59_write_state3 = ap_const_boolean_1) and (encodedOutStream_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((lz77DownsizedStream_6_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state2_pp0_stage0_iter1_assign_proc : process(lz77DownsizedStream_6_empty_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (lz77DownsizedStream_6_empty_n = ap_const_logic_0);
    end process;
    ...
    ap_loop_exit_ready <= ap_condition_exit_pp0_iter1_stage0;
    ap_phi_reg_pp0_iter0_outValue_data_V_20_reg_112 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ...
    encodedOutStream_din <= (outValue_strobe_V_fu_74 & ap_phi_reg_pp0_iter2_outValue_data_V_20_reg_112);
    ...
    lz77DownsizedStream_6_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, lz77DownsizedStream_6_empty_n, ap_block_pp0_stage0)
    begin
    ...
    lz77DownsizedStream_6_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    outValue_data_V_80_out <= p_Val2_s_fu_82;

    outValue_data_V_80_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, tmp_strobe_V_reg_351)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_strobe_V_reg_351 = ap_const_lv1_0))) then 
            outValue_data_V_80_out_ap_vld <= ap_const_logic_1;
        else 
            outValue_data_V_80_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    p_Result_45_fu_204_p5 <= (p_Val2_s_fu_82(31 downto 24) & trunc_ln414_fu_200_p1 & p_Val2_s_fu_82(15 downto 0));
    p_Result_46_fu_235_p5 <= (p_Val2_s_fu_82(31 downto 8) & trunc_ln674_fu_231_p1);
    p_Result_47_fu_183_p5 <= (trunc_ln414_3_fu_179_p1 & p_Val2_s_fu_82(23 downto 0));
    p_Result_s_fu_265_p5 <= (p_Val2_s_fu_82(31 downto 16) & tmp_fu_257_p3);
    tmp_fu_257_p3 <= (trunc_ln674_fu_231_p1 & ap_const_lv8_0);
    tmp_strobe_V_fu_171_p3 <= lz77DownsizedStream_6_dout(9 downto 9);
    tokenFlag_fu_159_p3 <= inValue_V_in_in_in_fu_70(8 downto 8);
    trunc_ln145_fu_167_p1 <= lz77DownsizedStream_6_dout(9 - 1 downto 0);
    trunc_ln414_3_fu_179_p1 <= inValue_V_in_in_in_fu_70(8 - 1 downto 0);
