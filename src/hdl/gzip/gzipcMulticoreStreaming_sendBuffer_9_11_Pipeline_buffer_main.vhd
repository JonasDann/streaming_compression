...
entity gzipcMulticoreStreaming_sendBuffer_9_11_Pipeline_buffer_main is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_sendBuffer_9_11_Pipeline_buffer_main is 
...
attribute shreg_extract : string;
    ...
    signal lz77PassStream_4_blk_n : STD_LOGIC;
    ...
    signal tmp_strobe_V_51_reg_219 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal sizeCntr_V_14_fu_169_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal ap_sig_allocacmp_sizeCntr_V_13 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) then
                if ((ap_const_boolean_1 = ap_condition_214)) then 
                    inVal_strobe_V_reg_109 <= tmp_strobe_V_51_reg_219;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_const_boolean_1 = ap_condition_217)) then 
                    sizeCntr_V_fu_62 <= sizeCntr_V_14_fu_169_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_phi_mux_inVal_strobe_V_phi_fu_112_p4 = ap_const_lv1_1) and (ap_phi_mux_loop_continue_phi_fu_135_p4 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_strobe_V_51_reg_219 <= lz77Stream_4_dout(9 downto 9);
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, lz77Stream_4_empty_n, ap_predicate_op25_read_state1, lz77PassStream_4_full_n, ap_predicate_op31_write_state2, ap_start_int)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_predicate_op31_write_state2 = ap_const_boolean_1) and (lz77PassStream_4_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op25_read_state1 = ap_const_boolean_1) and (lz77Stream_4_empty_n = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, lz77Stream_4_empty_n, ap_predicate_op25_read_state1, lz77PassStream_4_full_n, ap_predicate_op31_write_state2, ap_start_int)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_predicate_op31_write_state2 = ap_const_boolean_1) and (lz77PassStream_4_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op25_read_state1 = ap_const_boolean_1) and (lz77Stream_4_empty_n = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, lz77Stream_4_empty_n, ap_predicate_op25_read_state1, lz77PassStream_4_full_n, ap_predicate_op31_write_state2, ap_start_int)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_predicate_op31_write_state2 = ap_const_boolean_1) and (lz77PassStream_4_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op25_read_state1 = ap_const_boolean_1) and (lz77Stream_4_empty_n = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(lz77Stream_4_empty_n, ap_predicate_op25_read_state1)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_predicate_op25_read_state1 = ap_const_boolean_1) and (lz77Stream_4_empty_n = ap_const_logic_0));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(lz77PassStream_4_full_n, ap_predicate_op31_write_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((ap_predicate_op31_write_state2 = ap_const_boolean_1) and (lz77PassStream_4_full_n = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_inVal_strobe_V_phi_fu_112_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, tmp_strobe_V, tmp_strobe_V_51_reg_219, ap_loop_init, ap_condition_208)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) then
            if ((ap_const_boolean_1 = ap_condition_208)) then 
                ap_phi_mux_inVal_strobe_V_phi_fu_112_p4 <= tmp_strobe_V_51_reg_219;
            elsif ((ap_loop_init = ap_const_logic_1)) then 
    ...
    ap_sig_allocacmp_sizeCntr_V_13_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, sizeCntr_V_fu_62)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_sizeCntr_V_13 <= ap_const_lv17_0;
        else 
            ap_sig_allocacmp_sizeCntr_V_13 <= sizeCntr_V_fu_62;
        end if; 
    end process;
    ...
    lz77PassStream_4_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, lz77PassStream_4_full_n, ap_predicate_op31_write_state2, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_predicate_op31_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            lz77PassStream_4_blk_n <= lz77PassStream_4_full_n;
        else 
            lz77PassStream_4_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    lz77PassStream_4_din <= tmp_data_V_load_reg_214;

    lz77PassStream_4_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op31_write_state2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op31_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            lz77PassStream_4_write <= ap_const_logic_1;
        else 
    ...
    lz77Stream_4_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, lz77Stream_4_empty_n, ap_predicate_op25_read_state1, ap_block_pp0_stage0, ap_start_int)
    begin
    ...
    lz77Stream_4_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_predicate_op25_read_state1, ap_block_pp0_stage0_11001, ap_start_int)
    begin
    ...
    sizeCntr_V_14_fu_169_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_sizeCntr_V_13) + unsigned(ap_const_lv17_1));
    sizeCntr_V_out <= ap_sig_allocacmp_sizeCntr_V_13;
    ...
    trunc_ln145_fu_178_p1 <= lz77Stream_4_dout(9 - 1 downto 0);
end behav;
