...
begin
    mux_63_8_1_1_U453 : component gzipcMulticoreStreaming_mux_63_8_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    add_ln349_fu_147_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_m_3) + unsigned(ap_const_lv3_1));
    ...
    ap_sig_allocacmp_m_3_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, m_fu_62)
    begin
    ...
    icmp_ln349_fu_123_p2 <= "1" when (ap_sig_allocacmp_m_3 = ap_const_lv3_6) else "0";
    outValue_data_V_40_out <= p_Val2_s_fu_58;

    outValue_data_V_40_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln349_fu_123_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln349_fu_123_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            outValue_data_V_40_out_ap_vld <= ap_const_logic_1;
        else 
            outValue_data_V_40_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
