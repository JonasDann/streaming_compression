...
entity gzipcMulticoreStreaming_lz77DivideStream_14_4_Pipeline_ltree_init is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_lz77DivideStream_14_4_Pipeline_ltree_init is 
...
attribute shreg_extract : string;
    ...
    signal i_66_fu_86_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_65 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    and_ln152_fu_80_p2 <= (resetTree_12_load and icmp_ln152_fu_74_p2);
    ...
    ap_sig_allocacmp_i_65_assign_proc : process(ap_CS_fsm_state1, i_fu_38, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_i_65 <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_i_65 <= i_fu_38;
        end if; 
    end process;

    i_66_fu_86_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_65) + unsigned(ap_const_lv9_1));
    icmp_ln152_fu_74_p2 <= "1" when (unsigned(ap_sig_allocacmp_i_65) < unsigned(ap_const_lv9_11E)) else "0";
    ...
    zext_ln152_fu_92_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_65),64));
end behav;
