...
entity gzipcMulticoreStreaming_huffmanEncoderStream_Pipeline_init_litlen_tree_table is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gzipcMulticoreStreaming_huffmanEncoderStream_Pipeline_init_litlen_tree_table is 
...
attribute shreg_extract : string;
    ...
    signal i_V_18_reg_150 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal i_V_19_fu_103_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_sig_allocacmp_i_V_18 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                i_V_18_reg_150 <= ap_sig_allocacmp_i_V_18;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, hufCodeStream_0_empty_n)
    begin
                ap_block_pp0_stage0_01001 <= ((hufCodeStream_0_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_sig_allocacmp_i_V_18_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_V_fu_48)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i_V_18 <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_i_V_18 <= i_V_fu_48;
        end if; 
    end process;
    ...
    i_V_19_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V_18) + unsigned(ap_const_lv9_1));
    icmp_ln1073_fu_97_p2 <= "1" when (ap_sig_allocacmp_i_V_18 = ap_const_lv9_11D) else "0";
    ...
    trunc_ln441_fu_122_p1 <= hufCodeStream_0_dout(19 - 1 downto 0);
    zext_ln587_fu_118_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_V_18_reg_150),64));
end behav;
