...
module gzipcMulticoreStreaming_huffmanProcessingUnit_46_Pipeline_hf_proc_static_main (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        empty,
        outValue_data_V_112_out,
        outValue_data_V_112_out_ap_vld
);
...
input  [8:0] empty;
output  [31:0] outValue_data_V_112_out;
output   outValue_data_V_112_out_ap_vld;

reg ap_idle;
reg lz77Stream_2_read;
reg encodedOutStream_write;
reg outValue_data_V_112_out_ap_vld;
...
wire   [31:0] p_Result_67_fu_183_p5;
wire   [31:0] p_Result_66_fu_235_p5;
wire   [31:0] ap_phi_reg_pp0_iter0_outValue_data_V_36_reg_112;
reg   [31:0] ap_phi_reg_pp0_iter1_outValue_data_V_36_reg_112;
reg   [31:0] ap_phi_reg_pp0_iter2_outValue_data_V_36_reg_112;
...
wire   [31:0] p_Result_65_fu_204_p5;
wire   [31:0] p_Result_s_fu_265_p5;
reg    ap_block_pp0_stage0_01001;
wire   [7:0] trunc_ln414_7_fu_179_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_strobe_V_reg_351 <= lz77Stream_2_dout[32'd9];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_strobe_V_reg_351 == 1'd0))) begin
        outValue_data_V_112_out_ap_vld = 1'b1;
    end else begin
        outValue_data_V_112_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_predicate_op59_write_state3 == 1'b1) & (encodedOutStream_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((lz77Stream_2_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_predicate_op59_write_state3 == 1'b1) & (encodedOutStream_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((lz77Stream_2_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_predicate_op59_write_state3 == 1'b1) & (encodedOutStream_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((lz77Stream_2_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (lz77Stream_2_empty_n == 1'b0);
end
...
assign ap_phi_reg_pp0_iter0_outValue_data_V_36_reg_112 = 'bx;

always @ (*) begin
    ap_predicate_op59_write_state3 = ((next_state_load_reg_343 == 32'd3) | ((tokenFlag_reg_347 == 1'd0) & (next_state_load_reg_343 == 32'd0)));
end

assign encodedOutStream_din = {{outValue_strobe_V_fu_74}, {ap_phi_reg_pp0_iter2_outValue_data_V_36_reg_112}};

assign grp_fu_127_p2 = (outValue_strobe_V_fu_74 ^ 1'd1);

assign next_state_load_load_fu_156_p1 = next_state_fu_78;

assign outValue_data_V_112_out = p_Val2_s_fu_82;

assign p_Result_65_fu_204_p5 = {{p_Val2_s_fu_82[31:24]}, {trunc_ln414_fu_200_p1}, {p_Val2_s_fu_82[15:0]}};

assign p_Result_66_fu_235_p5 = {{p_Val2_s_fu_82[31:8]}, {trunc_ln674_fu_231_p1}};

assign p_Result_67_fu_183_p5 = {{trunc_ln414_7_fu_179_p1}, {p_Val2_s_fu_82[23:0]}};

assign p_Result_s_fu_265_p5 = {{p_Val2_s_fu_82[31:16]}, {tmp_fu_257_p3}};

assign tmp_fu_257_p3 = {{trunc_ln674_fu_231_p1}, {8'd0}};

assign tmp_strobe_V_fu_171_p3 = lz77Stream_2_dout[32'd9];

assign tokenFlag_fu_159_p3 = inValue_V_in_in_in_fu_70[32'd8];

assign trunc_ln145_fu_167_p1 = lz77Stream_2_dout[8:0];

assign trunc_ln414_7_fu_179_p1 = inValue_V_in_in_in_fu_70[7:0];
...
endmodule //gzipcMulticoreStreaming_huffmanProcessingUnit_46_Pipeline_hf_proc_static_main
