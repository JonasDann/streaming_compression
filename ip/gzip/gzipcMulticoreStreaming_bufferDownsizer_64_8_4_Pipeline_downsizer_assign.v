...
module gzipcMulticoreStreaming_bufferDownsizer_64_8_4_Pipeline_downsizer_assign (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        inSize_V_32,
        zext_ln1541,
        outVal_data_V_46_out,
        outVal_data_V_46_out_ap_vld
);
...
input  [67:0] inVal_V_78;
input  [3:0] inSize_V_32;
input  [3:0] zext_ln1541;
output  [7:0] outVal_data_V_46_out;
output   outVal_data_V_46_out_ap_vld;

reg ap_idle;
reg distStream_0_read;
reg downStream_0_write;
reg outVal_data_V_46_out_ap_vld;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
                        ...
                        outSizeV_V_fu_84[3 : 0] <= zext_ln1541_1_fu_205_p1[3 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            outVal_data_V_31_fu_80 <= {{p_Val2_s_fu_76[11:4]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            p_Val2_s_fu_76 <= inVal_V_26_reg_322;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op34_read_state2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        inVal_V_26_reg_322 <= distStream_0_dout;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1081_fu_168_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outVal_data_V_46_out_ap_vld = 1'b1;
    end else begin
        outVal_data_V_46_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((downStream_0_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op34_read_state2 == 1'b1) & (distStream_0_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((downStream_0_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op34_read_state2 == 1'b1) & (distStream_0_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((downStream_0_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op34_read_state2 == 1'b1) & (distStream_0_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op34_read_state2 == 1'b1) & (distStream_0_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (downStream_0_full_n == 1'b0);
end
...
assign downStream_0_din = {{1'd1}, {outVal_data_V_32_fu_227_p4}};

assign dsize_V_18_fu_180_p2 = (dsize_V_fu_72 + 4'd1);
...
assign inSize_V_3_fu_201_p1 = distStream_0_dout[3:0];

assign inVal_V_fu_237_p4 = {{p_Val2_s_fu_76[67:8]}};

assign outVal_data_V_32_fu_227_p4 = {{p_Val2_s_fu_76[11:4]}};

assign outVal_data_V_46_out = outVal_data_V_31_fu_80;

assign zext_ln1044_fu_247_p1 = inVal_V_fu_237_p4;

assign zext_ln1065_fu_186_p1 = dsize_V_18_fu_180_p2;

assign zext_ln1541_1_fu_205_p1 = inSize_V_3_fu_201_p1;
...
endmodule //gzipcMulticoreStreaming_bufferDownsizer_64_8_4_Pipeline_downsizer_assign
