...
module gzipcMulticoreStreaming_simpleStreamUpsizer_16_64_4_9_Pipeline_stream_upsizer_main (
        ...
        outVal_V_3_out_i,
        outVal_V_3_out_o,
        outVal_V_3_out_o_ap_vld,
        inVal_V_6_out_i,
        inVal_V_6_out_o,
        inVal_V_6_out_o_ap_vld,
        last_1_out,
        last_1_out_ap_vld
);
...
input  [1:0] tmp_strobe_V_3;
input  [0:0] loop_continue;
input  [63:0] outVal_V_3_out_i;
output  [63:0] outVal_V_3_out_o;
output   outVal_V_3_out_o_ap_vld;
input  [15:0] inVal_V_6_out_i;
output  [15:0] inVal_V_6_out_o;
output   inVal_V_6_out_o_ap_vld;
...
reg[63:0] outVal_V_3_out_o;
reg outVal_V_3_out_o_ap_vld;
reg[15:0] inVal_V_6_out_o;
reg inVal_V_6_out_o_ap_vld;
...
reg   [3:0] dsize_V_4_reg_488;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln233_fu_248_p2;
wire   [15:0] inVal_V_7_fu_331_p3;
reg   [15:0] inVal_V_7_reg_501;
wire    ap_loop_init;
reg   [3:0] ap_phi_mux_dsize_V_1_phi_fu_187_p4;
wire   [3:0] ap_phi_reg_pp0_iter0_dsize_V_1_reg_184;
wire   [0:0] loop_continue_4_fu_257_p2;
...
wire   [63:0] p_Result_5_fu_437_p3;
reg   [1:0] tmp_strobe_V_fu_96;
reg   [1:0] ap_sig_allocacmp_tmp_strobe_V_load;
reg   [1:0] ap_sig_allocacmp_tmp_strobe_V_load_2;
reg   [7:0] byteIdx_fu_100;
wire   [7:0] byteIdx_4_fu_339_p2;
reg   [7:0] ap_sig_allocacmp_byteIdx_load;
reg   [7:0] ap_sig_allocacmp_byteIdx_3;
reg   [3:0] dsize_V_fu_104;
wire   [3:0] dsize_V_5_fu_349_p2;
reg   [3:0] ap_sig_allocacmp_dsize_V_4;
reg   [7:0] tmp_data_V_2_fu_108;
wire   [7:0] tmp_data_V_5_fu_355_p1;
reg   [7:0] ap_sig_allocacmp_tmp_data_V_2_load;
reg   [7:0] tmp_data_V_3_fu_112;
reg   [7:0] ap_sig_allocacmp_tmp_data_V_3_load;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] p_Result_s_fu_291_p5;
wire   [15:0] inVal_V_fu_303_p3;
wire   [0:0] tmp_fu_311_p3;
wire   [15:0] p_Result_4_fu_319_p5;
wire   [3:0] zext_ln886_fu_345_p1;
wire   [47:0] outVal_V_5_fu_427_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((1'b1 == ap_condition_336)) begin
            tmp_data_V_3_fu_112 <= {{huffStream_1_dout[15:8]}};
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (*) begin
    if ((ap_phi_mux_loop_continue_2_phi_fu_176_p4 == 1'd1)) begin
        if ((icmp_ln233_fu_248_p2 == 1'd0)) begin
            ...
            ap_phi_mux_dsize_V_1_phi_fu_187_p4 = 4'd0;
        end else begin
...
always @ (*) begin
    if ((ap_phi_mux_loop_continue_2_phi_fu_176_p4 == 1'd1)) begin
        if ((icmp_ln1073_fu_285_p2 == 1'd1)) begin
            ...
            ap_phi_mux_inStVal_strobe_V_phi_fu_209_p4 = {{huffStream_1_dout[17:16]}};
        end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_dsize_V_4 = 4'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_phi_mux_loop_continue_2_phi_fu_176_p4 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        inVal_V_6_out_o_ap_vld = 1'b1;
    end else begin
        inVal_V_6_out_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (loop_continue_2_reg_173 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outVal_V_3_out_o_ap_vld = 1'b1;
    end else begin
        outVal_V_3_out_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_predicate_op67_write_state2 == 1'b1) & (mergeStream_1_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op53_read_state1 == 1'b1) & (huffStream_1_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_predicate_op67_write_state2 == 1'b1) & (mergeStream_1_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op53_read_state1 == 1'b1) & (huffStream_1_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_predicate_op67_write_state2 == 1'b1) & (mergeStream_1_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op53_read_state1 == 1'b1) & (huffStream_1_empty_n == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_predicate_op53_read_state1 == 1'b1) & (huffStream_1_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op67_write_state2 == 1'b1) & (mergeStream_1_full_n == 1'b0));
end
...
assign ap_phi_reg_pp0_iter0_dsize_V_1_reg_184 = 'bx;
...
assign byteIdx_4_fu_339_p2 = (ap_sig_allocacmp_byteIdx_3 + 8'd1);

assign dsize_V_5_fu_349_p2 = (ap_phi_mux_dsize_V_1_phi_fu_187_p4 + zext_ln886_fu_345_p1);

assign icmp_ln1073_fu_285_p2 = ((ap_sig_allocacmp_tmp_strobe_V_load_2 == 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln233_fu_248_p2 = ((ap_sig_allocacmp_byteIdx_load == 8'd4) ? 1'b1 : 1'b0);

assign inVal_V_7_fu_331_p3 = ((tmp_fu_311_p3[0:0] == 1'b1) ? p_Result_4_fu_319_p5 : inVal_V_fu_303_p3);

assign inVal_V_fu_303_p3 = ((icmp_ln1073_fu_285_p2[0:0] == 1'b1) ? inVal_V_6_out_i : p_Result_s_fu_291_p5);

assign last_1_out = last_reg_160;

assign loop_continue_4_fu_257_p2 = ((ap_sig_allocacmp_tmp_strobe_V_load != 2'd0) ? 1'b1 : 1'b0);

assign mergeStream_1_din = {{outVal_V_3_out_i}, {dsize_V_4_reg_488}};

assign outVal_V_5_fu_427_p4 = {{outVal_V_3_out_i[63:16]}};

assign p_Result_4_fu_319_p5 = {{ap_sig_allocacmp_tmp_data_V_3_load}, {inVal_V_fu_303_p3[7:0]}};

assign p_Result_5_fu_437_p3 = {{inVal_V_7_reg_501}, {outVal_V_5_fu_427_p4}};

assign p_Result_s_fu_291_p5 = {{inVal_V_6_out_i[15:8]}, {ap_sig_allocacmp_tmp_data_V_2_load}};

assign tmp_data_V_5_fu_355_p1 = huffStream_1_dout[7:0];

assign tmp_fu_311_p3 = ap_sig_allocacmp_tmp_strobe_V_load_2[32'd1];

assign zext_ln886_fu_345_p1 = ap_sig_allocacmp_tmp_strobe_V_load_2;
