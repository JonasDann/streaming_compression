...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_compress_leftover_6 (
        ...
        present_window_140_reload,
        present_window_139_reload,
        present_window_138_reload,
        present_window_137_reload,
        present_window_136_reload,
        outValue_data_V_47_out,
        outValue_data_V_47_out_ap_vld
);
...
input  [7:0] present_window_140_reload;
input  [7:0] present_window_139_reload;
input  [7:0] present_window_138_reload;
input  [7:0] present_window_137_reload;
input  [7:0] present_window_136_reload;
output  [31:0] outValue_data_V_47_out;
output   outValue_data_V_47_out_ap_vld;

reg ap_idle;
reg compressedStream_write;
reg outValue_data_V_47_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln349_fu_123_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outValue_data_V_47_out_ap_vld = 1'b1;
    end else begin
        outValue_data_V_47_out_ap_vld = 1'b0;
    end
end
...
assign add_ln349_fu_147_p2 = (ap_sig_allocacmp_m_2 + 3'd1);
...
assign icmp_ln349_fu_123_p2 = ((ap_sig_allocacmp_m_2 == 3'd6) ? 1'b1 : 1'b0);

assign outValue_data_V_47_out = p_Val2_s_fu_58;
