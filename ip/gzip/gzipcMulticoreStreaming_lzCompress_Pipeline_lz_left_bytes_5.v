...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_left_bytes_5 (
        ...
        outValue_data_V_40_reload,
        outValue_data_V_42_out,
        outValue_data_V_42_out_ap_vld
);
...
input  [31:0] outValue_data_V_40_reload;
output  [31:0] outValue_data_V_42_out;
output   outValue_data_V_42_out_ap_vld;

reg ap_idle;
reg lclBufStream_read;
reg compressedStream_write;
reg outValue_data_V_42_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln355_fu_107_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outValue_data_V_42_out_ap_vld = 1'b1;
    end else begin
        outValue_data_V_42_out_ap_vld = 1'b0;
    end
end
...
assign add_ln355_fu_113_p2 = (ap_sig_allocacmp_l_3 + 7'd1);
...
assign icmp_ln355_fu_107_p2 = ((ap_sig_allocacmp_l_3 == 7'd64) ? 1'b1 : 1'b0);

assign outValue_data_V_42_out = p_Val2_s_fu_60;
