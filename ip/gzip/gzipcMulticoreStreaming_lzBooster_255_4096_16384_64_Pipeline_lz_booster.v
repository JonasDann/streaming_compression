...
module gzipcMulticoreStreaming_lzBooster_255_4096_16384_64_Pipeline_lz_booster (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        boosterStream_write,
        tmp_data_V_61_reload,
        trunc_ln,
        outValue_V,
        outValue_V_32_out,
        outValue_V_32_out_ap_vld
);
...
input  [31:0] tmp_data_V_61_reload;
input  [0:0] trunc_ln;
input  [31:0] outValue_V;
output  [31:0] outValue_V_32_out;
output   outValue_V_32_out_ap_vld;
...
wire   [31:0] tmp_data_V_50_fu_317_p1;
reg   [31:0] tmp_data_V_50_reg_750;
reg   [0:0] tmp_reg_755;
reg   [31:0] outValue_V_1_reg_760;
reg   [31:0] outValue_V_1_reg_760_pp0_iter2_reg;
reg   [31:0] outValue_V_1_reg_760_pp0_iter3_reg;
...
wire    ap_loop_init;
reg   [8:0] ap_phi_mux_skip_len_4230_phi_fu_242_p4;
wire  signed [8:0] skip_len_3_fu_500_p3;
wire   [8:0] ap_phi_reg_pp0_iter3_skip_len_4230_reg_239;
reg   [0:0] ap_phi_mux_matchFlag_4224_phi_fu_252_p4;
wire   [0:0] ap_phi_reg_pp0_iter3_matchFlag_4224_reg_249;
...
always @ (*) begin
    if ((1'b1 == ap_condition_349)) begin
        if ((icmp_ln508_fu_481_p2 == 1'd1)) begin
            ap_phi_mux_matchFlag_4224_phi_fu_252_p4 = 1'd0;
...
always @ (*) begin
    if ((1'b1 == ap_condition_349)) begin
        if ((icmp_ln508_fu_481_p2 == 1'd1)) begin
            ap_phi_mux_skip_len_4230_phi_fu_242_p4 = 9'd0;
        end else if ((icmp_ln508_fu_481_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((nextVal_strobe_V_reg_228_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        outValue_V_32_out_ap_vld = 1'b1;
    end else begin
        outValue_V_32_out_ap_vld = 1'b0;
    end
end
...
assign add_ln441_fu_594_p2 = (empty_230_fu_406_p1 + 12'd1);
...
assign ap_phi_reg_pp0_iter3_matchFlag_4224_reg_249 = 'bx;

assign ap_phi_reg_pp0_iter3_skip_len_4230_reg_239 = 'bx;
...
assign boostFlag_fu_367_p2 = ((tmp_200_fu_357_p4 == 4'd0) ? 1'b1 : 1'b0);

assign boosterStream_din = {{1'd1}, {outStreamValue_data_V_fu_132}};

assign empty_230_fu_406_p1 = match_loc_fu_120[11:0];

assign empty_231_fu_386_p1 = iIdx_fu_112[11:0];

assign iIdx_10_fu_380_p2 = (iIdx_fu_112 + 32'd1);
...
assign match_len_2_fu_582_p2 = (match_len_fu_124 + 32'd1);

assign match_loc_2_fu_588_p2 = (match_loc_fu_120 + 32'd1);

assign match_loc_3_fu_467_p2 = (iIdx_9_reg_791 - zext_ln487_fu_410_p1);

assign outFlag_fu_476_p2 = ((iIdx_9_reg_791 != 32'd0) ? 1'b1 : 1'b0);

assign outValue_V_32_out = outStreamValue_data_V_fu_132;

assign p_Result_s_fu_651_p5 = {{outStreamValue_data_V_fu_132[31:16]}, {add_ln392_fu_646_p2}, {outStreamValue_data_V_fu_132[7:0]}};

assign sext_ln174_fu_551_p1 = $signed(ap_phi_mux_skip_len_4230_phi_fu_242_p4);

assign sext_ln449_fu_508_p1 = skip_len_3_fu_500_p3;

assign skip_len_1_fu_419_p2 = ($signed(skip_len_fu_108) + $signed(16'd65535));

assign skip_len_2_fu_494_p2 = ($signed(zext_ln514_fu_491_p1) + $signed(9'd511));

assign skip_len_3_fu_500_p3 = ((boostFlag_reg_784_pp0_iter2_reg[0:0] == 1'b1) ? 9'd0 : skip_len_2_fu_494_p2);

assign tCh_fu_333_p1 = lclBufStream_dout[7:0];

assign tmp_200_fu_357_p4 = {{lclBufStream_dout[31:28]}};

assign tmp_data_V_50_fu_317_p1 = compressedStream1_dout[31:0];

assign trunc_ln441_fu_472_p1 = match_loc_3_fu_467_p2[11:0];

assign trunc_ln499_fu_578_p1 = match_len_fu_124[7:0];

assign zext_ln487_fu_410_p1 = tOffset_reg_779_pp0_iter2_reg;

assign zext_ln493_fu_390_p1 = empty_231_fu_386_p1;
...
assign zext_ln520_fu_425_p1 = empty_230_fu_406_p1;

endmodule //gzipcMulticoreStreaming_lzBooster_255_4096_16384_64_Pipeline_lz_booster
