...
input  [7:0] tmp_data_V_84_reload;
...
wire   [7:0] tmp_data_V_32_fu_135_p1;
wire    ap_loop_init;
reg   [6:0] i_fu_64;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            tmp_data_V_fu_60 <= tmp_data_V_84_reload;
...
assign add_ln261_fu_120_p2 = (ap_sig_allocacmp_i_6 + 7'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((lclBufStream_full_n == 1'b0) | (downStream_0_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((lclBufStream_full_n == 1'b0) | (downStream_0_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((lclBufStream_full_n == 1'b0) | (downStream_0_empty_n == 1'b0)));
end
...
assign icmp_ln261_fu_114_p2 = ((ap_sig_allocacmp_i_6 == 7'd64) ? 1'b1 : 1'b0);
...
assign tmp_data_V_32_fu_135_p1 = downStream_0_dout[7:0];
