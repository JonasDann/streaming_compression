...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_left_bytes_2 (
        ...
        outValue_data_V_19_reload,
        outValue_data_V_21_out,
        outValue_data_V_21_out_ap_vld
);
...
input  [31:0] outValue_data_V_19_reload;
output  [31:0] outValue_data_V_21_out;
output   outValue_data_V_21_out_ap_vld;

reg ap_idle;
reg lclBufStream_read;
reg compressedStream_write;
reg outValue_data_V_21_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln355_fu_107_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outValue_data_V_21_out_ap_vld = 1'b1;
    end else begin
        outValue_data_V_21_out_ap_vld = 1'b0;
    end
end
...
assign add_ln355_fu_113_p2 = (ap_sig_allocacmp_l_6 + 7'd1);
...
assign icmp_ln355_fu_107_p2 = ((ap_sig_allocacmp_l_6 == 7'd64) ? 1'b1 : 1'b0);

assign outValue_data_V_21_out = p_Val2_s_fu_60;
