...
module gzipcMulticoreStreaming_lzCompress_Pipeline_lz_compress_leftover_1 (
        ...
        present_window_36_reload,
        outValue_data_V_12_out,
        outValue_data_V_12_out_ap_vld
);
...
input  [7:0] present_window_36_reload;
output  [31:0] outValue_data_V_12_out;
output   outValue_data_V_12_out_ap_vld;

reg ap_idle;
reg compressedStream_write;
reg outValue_data_V_12_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln349_fu_123_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        outValue_data_V_12_out_ap_vld = 1'b1;
    end else begin
        outValue_data_V_12_out_ap_vld = 1'b0;
    end
end
...
assign add_ln349_fu_147_p2 = (ap_sig_allocacmp_m_7 + 3'd1);
...
assign icmp_ln349_fu_123_p2 = ((ap_sig_allocacmp_m_7 == 3'd6) ? 1'b1 : 1'b0);

assign outValue_data_V_12_out = p_Val2_s_fu_58;
